...
<!-- MODX by the phpBB MOD Team XSL file v1.2.1 copyright 2005-2008 the phpBB MOD Team.
	$Id: modx.prosilver.en.xsl,v 1.1.1.1 2009/05/15 04:02:02 damysterious Exp $ -->
...
var enStrings = "h1=Istruzioni di installazione per\n" +
"edt-show=Show&nbsp;&gt;&gt;\n" +
"edt-hide=&lt;&lt;&nbsp;Hide\n" +
"V=Version\n" +
"t=Title:\n" +
...
function toggle_edit(o)
{
	...
	return toggle_display(o, s);
		...
		<div id="wrap">
			<div id="page-header">
				<h1><span id="lang-h1">Istruzioni di installazione per </span> '<xsl:value-of select="$title" />' <span id="lang-V">Versione</span>&nbsp;<xsl:value-of select="$version" /></h1>
