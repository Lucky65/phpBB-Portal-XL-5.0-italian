...
$lang = array_merge($lang, array(   
	...
	'TITLE_EXPLAIN'				=> 'Από εδώ μπορείτε να δημιουργήσετε/επεξεργαστείτε/διαγράψετε ένα Μενού. Αυτό το block μπορεί να ενεργοποιηθεί/απενεργοποιηθεί από <strong>Portal</strong> -> <strong>Γενικά</strong> -> <strong>Μενού περιήγησης</strong>. Τα εικονίδια που χρησιμοποιούνται σε αυτό το μενού βρίσκονται στον φάκελο /portal/images/icon_links/. Προτεινόμενο μέγεθος εικονιδίων 16x16px. Προσθέστε όσα εικονίδια θέλετε αλλά να έχετε υπόψη ότι η προεπισκόπηση τους θα παραμορφώσει το παράθυρο Διαθέσιμων mini εικονιδίων κατά την επεξεργασία ή την προσθήκη κάποιου μενού.<br /> Η διαδρομή είναι σχετική με το φάκελο root της κοινότητας, π.χ. "http://www.ησελίδασας.com/" για εξωτερικό δεσμό. Οι εσωτερικοί δεσμοί μπορούν να δοθούν ως "portal.php" για ένα συγκεκριμένο αρχείο της κοινότητας σας, ή "memberlist.php?mode=leaders" για μια συγκεκριμένη λειτουργία της δημ. συζήτησης σας.',
