...
* @version $Id: acp_portal_xl_links.php,v 1.1.1.1 2009/05/15 04:02:40 damysterious Exp $
*
...
$lang = array_merge($lang, array(   
	...
	'TITLE_EXPLAIN'				=> 'From this form, you can create/edit/move/delete a custom link Item. This menu block can be switched on/off in Portal -> General -> Links. Icons for use in this menu are placed in directory /portal/images/icon_links/. Recommended icon size 16x16px. Add as many icons as you like but keep in mind the preview will show them all, which will stretch the Available mini icons window in the edit menu or add menu section. Path is relative to the forums root directory, i.e. "http://www.yourdomain.com/" for a external link.',
