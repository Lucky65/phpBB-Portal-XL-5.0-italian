...
$help = array(
	...
	array(
		...
		1 => 'De link naar de downloadpagina is te vinden bovenaan iedere pagina in de navigatie. Directe link: [<a href="' . append_sid("{$phpbb_root_path}downloads.$phpEx") . '">Downloads</a>]'
	),
	array(
		0 => 'Wat betekend ' . $user->img('dl_blue') . '?',
		1 => 'Geen download mogelijk. Het totale verkeer dat is ingesteld door de beheerder voor de download, of voor de weergegeven categorie is verbruikt voor deze maand.'
	),
	array(
		0 => 'Wat betekend ' . $user->img('dl_red') . '?',
		1 => 'Geen download mogelijk. Dit kan betekenen dat:<br />- De download is geblokkeerd door een beheerder.<br />- De gebruiker is niet ingelogt, maar downloaden is alleen toegestaan voor geregistreerde gebruikers.<br />- De gebruiker heeft niet genoeg dataverkeer om dit bestand te downloaden.<br />- De beheerder vereist een minimum aantal berichten, die de gebruiker niet heeft.<br />- Het dataverkeer voor dit bestand is compleet verbruikt.'
	),
	array(
		0 => 'Wat betekend ' . $user->img('dl_grey') . '?',
		1 => 'Externe bron. De download wordt gestart vanaf een externe server. Dit zal worden behandeld als ' . $user->img('dl_green') . '. Deze download gaat niet ten koste van het gebruikersverkeer en het totale dataverkeer.'
	),
	array(
		0 => 'Wat betekend ' . $user->img('dl_white') . '?',
		1 => 'Net zoals ' . $user->img('dl_green') . ' het gebruikers verkeer zal niet worden verlaagt, maar alleen geregistreerde gebruikers kunnen dit bestand downloaden. Het totale verkeer zal wel verlaagt worden.'
	),
	array(
		0 => 'Wat betekend ' . $user->img('dl_yellow') . '?',
		1 => 'Download mogelijk met beperkingen. Deze download is alleen mogelijk voor geregistreerde gebruikers. De bestandsgrootte zal worden afgetrokken van het gebruikersaccount en van het totale dataverkeer.'
	),
	array(
		0 => 'Wat betekend ' . $user->img('dl_green') . '?',
		1 => 'Vrije download. Iedereen kan dit bestand downloaden, inclusief gasten. Alleen het totale dataverkeer zal dalen.'
	),
	array(
		0 => 'Waarom kan ik geen bestanden downloaden?',
		1 => 'Dit kan meerdere redenen hebben. Kijk bij ' . $user->img('dl_blue') . ' en ' . $user->img('dl_red')
	),
	array(
		0 => 'Hoe en wanneer krijg ik nieuw dataverkeer voor mijn account?',
		1 => 'Na de eerste keer inloggen heeft de gebruiker een tijdvertraging voor het verkrijgen van dataverkeer. Elke eerste dag van de maand wordt het dataverkeer vernieuwd. Vraag de beheerder voor de hoeveelheid dataverkeer die jij krijgt.'
	),
	array(
		0 => 'Ik wil graag een bestand downloaden, maar ik heb geen dataverkeer meer?',
		1 => 'In dit geval kun je contact opnemen met de beheerder. Alleen hij kan het dataverkeer verhogen voordat het account automatisch nieuw dataverkeer krijgt aan het begin van de maand.'
	),
	array(
		0 => 'Hoe kan ik downloads waarderen?',
		1 => 'Achter elke download in een categorie of in de details vind je een knop om een download te waarderen.<br />Door te klikken op "Waardeer" kan een geregistreerde gebruiker de download waarderen van 1 punt (zeer slecht) tot 10 punten (uitstekend). Een download kan slechts eenmalig gewaardeerd worden per gebruiker.'
	),
	array(
		0 => '--',
		1 => 'phpBB 3 vragen'
