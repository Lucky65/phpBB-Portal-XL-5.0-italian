...
$lang = array_merge($lang, array(
	...
	'FIELD_TOO_SMALL'					=> 'De waarde van "%1$s" is te klein, een minimum-waarde van %2$d is vereist.',
	'FIELD_TOO_LARGE'					=> 'De waarde van "%1$s" is te groot, een maximum-waarde van %2$d is toegestaan.',
...
// Anti Bot Question
$lang = array_merge($lang, array(
	'AB_QUESTION_ERROR'	=> 'Het ingegeven antwoord is onjuist, controleer je ingave en probeer opniew.',
	'AB_NO_ANSWER'		=> 'Er is geen antwoord opgegeven.',
));

// phpbb Calendar Version 0.1.0
$lang = array_merge($lang, array(
	'DISPLAY_EVENTS_DAYCOUNT' => 'Tot hoeveel dagen in de toekomst wil je gaan?',
	'UCP_MAIN_CALENDAR_MYEVENTS' => 'Beheer de gebeurtenissen',
	'UCP_MAIN_CALENDAR_REGISTRATION'=> 'Beheer de gebeurtenisregistratie',
));
