...
$lang = array_merge($lang, array(
	...
	'HTML_URL' => 'HTML URL',
	'HTML_URL_EXPLAIN' => 'Enter the full URL to your map.php file, eg http://www.example.com/eventual_dir/ if map.php is installed in http://www.example.com/eventual_dir/.<br/>This option is useful when phpBB is not installed in the domain’s root and you would like put the map.php file in the root level.',
	...
	'HTML_NEWS_EXPLAIN' => 'Here you can set up various content filtering / formating options for the news. <br/>They can be applied to all the HTML modules depending on your HTML override settings.',
	...
	'HTML_ALLOW_LINKS_EXPLAIN' => 'You may choose here to either activate or not links used in items content.<br/> If desactivated, links and emails will be included in the content but won’t be clickable.',
