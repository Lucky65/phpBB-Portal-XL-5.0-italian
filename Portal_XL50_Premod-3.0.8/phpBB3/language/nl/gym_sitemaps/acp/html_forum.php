...
$lang = array_merge($lang, array(
	...
	'HTML_FORUM_EXPLAIN' => 'These are the setting for the HTML forum module.<br/> Some of them can be overridden depending on the HTML override settings.',
	'HTML_FORUM_EXCLUDE' => 'Forum Exclusions',
	'HTML_FORUM_EXCLUDE_EXPLAIN' => 'You can here exclude one or several forum from the RSS listing.<br /><u>Note :</u> If this field is left empty, all readable forums will be listed.',
	...
	'HTML_FORUM_ALLOW_CAT_NEWS_EXPLAIN' => 'Activate, or not, the per forum news pages. If activated, each non excluded forum will have a news page for it’s topics.',
	'HTML_FORUM_NEWS_IDS' => 'Froum news source',
	...
	'HTML_FORUM_FIRST_EXPLAIN' => 'The forum maps can be sorted aginst the topic first post date or the the topic last post date. This means that you can either use the topic creation or the last replied order.',
	'HTML_FORUM_NEWS_FIRST' => 'News sorting',
	'HTML_FORUM_NEWS_FIRST_EXPLAIN' => 'The forum news pages can be sorted aginst the topic first post date or the the topic last post date. This means that you can either use the topic creation or the last replied order.',
