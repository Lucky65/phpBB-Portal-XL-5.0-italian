...
$help = array(
	...
	array(
		0 => 'Een video toevoegen aan een bericht',
		1 => 'Videos kunnen, indien de beheerder de bijlagenfunctie heeft aangezet en je de nodige permissies hebt om bijlagen toe te voegen, overal worden toegevoegd door middel van de <strong>[youtube][/youtube]</strong> tag. In het berichtvenster is er een selectie lijst om bijlagen toe te voegen. Youtube voorbeeld:<br /><br /><strong>[youtube]</strong>http://de.youtube.com/watch?v=ADbeCHQLUpk<strong>[/youtube]</strong>'
	),
	array(
		0 => '--',
		1 => 'Andere'
