...
$lang = array_merge($lang, array(
	'PORTAL'								=> 'Portaal',
   	...
   	'ACP_PORTAL'           					=> 'Portaal',
   	'ACP_PORTAL_ADMIN'           			=> 'Algemeen',
   	'ACP_PORTAL_INFO'           			=> 'Algemeen',	
	...
	'ACP_PORTAL_BLOCKS_INDEX'				=> 'Index blokken',
	'ACP_MANAGE_INDEX_BLOCKS'				=> 'Beheer index blokken',

	// Portal XL portal menu //
   	'ACP_PORTAL_CAT_MENUS'           		=> 'Menu\'s',
   	'ACP_PORTAL_ADMIN_MENUS'           		=> 'Menu\'s',
	'ACP_PORTAL_MENU'						=> 'Menu\'s',
	'ACP_MANAGE_MENUS'						=> 'Beheer menu\'s',
		
	// Portal XL portal quotes //
   	'ACP_PORTAL_CAT_QUOTES'           		=> 'Citaten',
   	'ACP_PORTAL_ADMIN_QUOTES'           	=> 'Citaties',
	'ACP_PORTAL_QUOTES'						=> 'Citaten',
	'ACP_MANAGE_QUOTES'						=> 'Beheer citaten',
	...
	// Portal XL portal banners horizontal //
   	'ACP_PORTAL_CAT_BANNERS_HO'          		=> 'Horizontale banners',
   	'ACP_PORTAL_ADMIN_BANNERS_HO'           	=> 'Horizontale banners 400x60',
	'ACP_PORTAL_BANNERS_HO'						=> 'Horizontale banners',
	'ACP_MANAGE_BANNERS_HO'						=> 'Beheer banners 400x60',

	// Portal XL portal banners vertical //
   	'ACP_PORTAL_CAT_BANNERS_VE'          		=> 'Verticale banners',
   	'ACP_PORTAL_ADMIN_BANNERS_VE'           	=> 'Verticale banners 130x600',
	'ACP_PORTAL_BANNERS_VE'						=> 'Verticale banners',
	...
	// Portal XL portal pages //
   	'ACP_PORTAL_CAT_PAGES'           			=> 'Portaal pagina\'s',
   	'ACP_PORTAL_ADMIN_PAGES'         			=> 'Portaal pagina\'s',
	'ACP_PORTAL_PAGES'							=> 'Portaal pagina\'s',
	'ACP_MANAGE_PAGES'							=> 'Beheer portaal pagina\'s',
		
	// Portal XL portal newsfeeds //
   	'ACP_PORTAL_CAT_NEWSFEEDS'           		=> 'Portaal nieuws feeds',
   	'ACP_PORTAL_ADMIN_NEWSFEEDS'         		=> 'Portaal nieuws feeds',
	'ACP_PORTAL_NEWSFEEDS'						=> 'Portaal nieuws feeds',
	'ACP_MANAGE_NEWSFEEDS'						=> 'Beheer nieuws feeds',
	...
	// Portal XL portal impressum //
   	'ACP_PORTAL_CAT_IMPRESSUM'           		=> 'Portaal disclaimer',
   	'ACP_PORTAL_ADMIN_IMPRESSUM'         		=> 'Portaal disclaimer',
	'ACP_PORTAL_IMPRESSUM'						=> 'Portaal disclaimer',
	'ACP_MANAGE_IMPRESSUM'						=> 'Beheer disclaimer',
		
	// Portal XL portal log entries
	'LOG_CONFIG_PORTAL'				=> '<strong>Portaal algemeen opgeslagen</strong>',
	'LOG_CONFIG_ANNOUNCEMENTS'		=> '<strong>Portaal mededelingen opgeslagen</strong>',
	'LOG_CONFIG_NEWS'				=> '<strong>Portaal nieuws opgeslagen</strong>',
	'LOG_CONFIG_RECENT'				=> '<strong>Portaal recente onderwerpen opgeslagen</strong>',
	'LOG_CONFIG_WORDGRAPH'			=> '<strong>Portaal wordgraph opgeslagen</strong>',
	'LOG_CONFIG_COLLUMN'			=> '<strong>Portaal kolom breedte opgeslagen</strong>',
	'LOG_CONFIG_PAYPAL'				=> '<strong>Portaal paypal opgeslagen</strong>',
	'LOG_CONFIG_ATTACHMENTS'		=> '<strong>Portaal bijlagen opgeslagen</strong>',
	'LOG_CONFIG_MEMBERS'			=> '<strong>Portaal leden opgeslagen</strong>',
	'LOG_CONFIG_POLLS'				=> '<strong>Portaal poll opgeslagen</strong>',
	'LOG_CONFIG_BOTS'				=> '<strong>Portaal bezoekende bots opgeslagen</strong>',
	'LOG_CONFIG_POSTER'				=> '<strong>Portaal actiefste gebruiker opgeslagen</strong>',
	'LOG_CONFIG_RANDOM'				=> '<strong>Portaal random opgeslagen</strong>',
	'LOG_CONFIG_WELCOME'			=> '<strong>Portaal welkom opgeslagen</strong>',
	'LOG_CONFIG_WEATHER'	    	=> '<strong>Portaal weer opgeslagen</strong>',
	'LOG_CONFIG_SYNDICATE'	    	=> '<strong>Portaal sydicatie opgeslagen</strong>',
	'LOG_CONFIG_PLUXLINDEX'	    	=> '<strong>Portaal board/viewtopic index opgeslagen</strong>',
  	'LOG_CONFIG_SCROLLMESSAGE'      => '<strong>Portaal scroll bericht opgeslagen</strong>',
  	'LOG_CONFIG_METATAGS'      		=> '<strong>Portaal META tags instellingen opgeslapen</strong>',
	
	// installation logging
	'PORTAL_LOG_INSTALL_PORTAL'	=> '<strong>Portal XL geinstalleerd</strong>',
	'PORTAL_LOG_UNINSTALL_PORTAL'	=> '<strong>Portal XL verwijderd</strong>',
	'PORTAL_LOG_UPDATE_PORTAL'	=> '<strong>Portal XL database update</strong>',
...
$lang = array_merge($lang, array(
	...
	'COUNTER_STARTED'		=> 'Teller begonnen op',
	'HITS_PER_DAY'			=> 'Bezoeken per dag',
	'LOG_CONFIG_COUNTER'	=> '<strong>Gewijzigde teller instellingen</strong>',
	'LOG_RESET_COUNTER'		=> '<strong>Teller gereset: gestartte dag, tijd en bezoekers waarde</strong>',
	'NUMBER_HITS'			=> 'Aantal bezoeken',
	'RESET_COUNTER'			=> 'Herstel teller',
	'RESET_COUNTER_CONFIRM'	=> 'Weet je zeker dat je alle data wilt herstellen?',
	'RESET_COUNTER_EXPLAIN'	=> 'Herstel van alle data van de teller: gestartte dag, tijd en bezoekers waarde.',
));
...
$lang = array_merge($lang, array(
    ...
    'ACP_CALENDAR_DELETE_EVENT_TYPE'	=> 'Verwijder evenement type',
    'ACP_CALENDAR_ETYPES'				=> 'Beheer kalender evenement types',
));

// Country Flags Version 3.0.6
$lang = array_merge($lang, array(
	'ACP_FLAG_SETTINGS'		=> 'Country flag settings',
	'ACP_FLAGS'				=> 'Country flags',
	'ACP_MANAGE_FLAGS'		=> 'Manage country flags',
	'ACP_USER_FLAG'			=> 'Country flag',
	'ACP_USER_COUNTRY_FLAG'	=> 'Country flag',
	'LOG_CONFIG_FLAG'		=> '<strong>Altered country flag settings</strong>',
	'LOG_FLAG_ADDED'		=> '<strong>Added new country flag</strong><br />» %1$s (%2$s)',
	'LOG_FLAG_REMOVED'		=> '<strong>Removed country flag</strong><br />» %1$s (%2$s)',
	'LOG_FLAG_UPDATED'		=> '<strong>Updated country flag</strong><br />» %1$s (%2$s)',
));
