...
$lang = array_merge($lang, array(
    ...
    'ACP_NO_ITEMS'            	=> 'Non sono ancora stati generati backup.',
...
$lang = array_merge($lang, array(
	...
	// Portal XL portal adds //
   	'ACP_PORTAL_CAT_ADDS'           			=> 'Pubblicità forum',
   	'ACP_PORTAL_ADMIN_ADDS'         			=> 'Pubblicità forum',
	'ACP_PORTAL_ADDS'							=> 'Pubblicità forum',
	'ACP_MANAGE_ADDS'							=> 'Gestione pubblicità',
...
$lang = array_merge($lang, array(
	...
	<p>Una nuova versione di phpBB SEO premod è disponibile : %1$s<br/>Visita<a href="%2$s" title="The release thread"><b>the release thread</b></a> e aggiorna la tua installazione.</p>',
...
$lang = array_merge($lang, array(
	...
	'LOG_CONTACT_BOT_INVALID'		=> '<strong>Il contatto non è un valido user id: %s</strong>',
	'LOG_CONTACT_FORUM_INVALID'		=> '<strong>Il contatto selezionato non è valido per :</strong><br />l’ID %1$s del Forum',
...
$lang = array_merge($lang, array(
	...
	'NO_INFO'				=> 'Nessuna informazione di versione, il server non può essere contattato',
...
$lang = array_merge($lang, array(
	...
	'ACP_BLOCK_LOGS_EXPLAIN'	=> 'Elenca le azioni svolte tramite fuso orario e verifica ad esempio i DNS durante la registrazione degli utenti. Questo registro contiene informazioni che è possibile utilizzare per controllare la funzione DNSBL di controllo. Se si dispone di autorizzazioni appropriate è inoltre possibile azzerare singole operazioni o il registro nel suo insieme.<br /><strong> I diversi registri devono essere abilitati nelle impostazioni di protezione</strong>',
