...
$lang = array_merge($lang, array(
	...
	'BUMP_INTERVAL_EXPLAIN'			=> 'Numero di minuti, ore o giorni trascorsi fra l’ultimo messaggio di un argomento e la possibilità di spostarlo in cima. Impostando su 0 si disabilita questa azione.',
...
$lang = array_merge($lang, array(
	...
	'NEW_MEMBER_POST_LIMIT'     => 'Minimo messaggi per Nuovi Utenti Registrati',
...
$lang = array_merge($lang, array(
	...
	'YES_BIRTHDAYS_EXPLAIN'			=> 'Se disabilitato, il Pannello Compleanni non sarà più visualizzato. Perchè questa impostazione abbia effetto anche l’altra opzione compleanni deve essere attivata.',
...
$lang = array_merge($lang, array(
	...
	'LDAP_PASSWORD_EXPLAIN'			=> 'Lascia il campo vuoto per usare un accesso anonimo. Oppure compila con la password per l’utente sopra specificato. Obbligatorio per server Active Directory. <br /><em><strong>Attenzione:</strong> Questa password verrà memorizzata come testo in chiaro nel database e visibile a chi può accedere al tuo database o a questa pagina di configurazione.</em>',
...
$lang = array_merge($lang, array(
	...
	'AB_ANSWER_EXPLAIN'			=> 'Questa è la risposta per la domanda.',
	'AB_ANSWER_2'				=> 'Seconda Risposta Anti-Bot',
	'AB_ANSWER_2_EXPLAIN'		=> 'Qui puoi aggiungere una seconda domanda, una buona idea è usare una domanda che richiede una risposta numerica.',
	'AB_QUESTION_MOD'			=> 'Domanda Anti-Bot',
	'AB_QUESTION'				=> 'Domanda Anti-Bot',
	'AB_QUESTION_EXPLAIN'		=> 'Questa è una domanda ad un utente non registrato.',
...
$lang = array_merge($lang, array(
	...
	'ACP_FRIENDS_AV_SIZE_EXPLAIN'	=> 'La dimensione dell’avatar visualizzato deve essere compreso tra 20 e 100 pixel, è raccomandato il valore di 80 pixel',
...
$lang = array_merge($lang, array(
	...
	'CHECK_TZ_EXPLAIN'				=> 'Se abilitato il fuso orario utente viene verificato con i valori di non-terrestre di -19 e 19 durante la registrazione. Gli spammer spesso utilizzano la prima o l’ultima voce del menù a discesa. Se questa opzione è abilitata due valori strani si aggiungono all’inizio e alla fine del menù a tendina solo in registrazione.',
