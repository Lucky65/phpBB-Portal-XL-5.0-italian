...
$lang = array_merge($lang, array(
	// Install
	'SEO_INSTALL_PANEL'	=> 'Mappa sito GYM &amp; RSS pannello di installazione',
	'CAT_INSTALL_GYM_SITEMAPS' => 'Installa mappa sito GYM',
	'CAT_UNINSTALL_GYM_SITEMAPS' => 'Disinstalla mappa sito GYM',
	'CAT_UPDATE_GYM_SITEMAPS' => 'Aggiorna mappa sito GYM',
	...
	'CAT_SEO_PREMOD'	=> 'Mappa sito GYM &amp; RSS',
	'SEO_INSTALL_INTRO'		=> 'Benvenuto sull’installazione di phpBB SEO mappa sito GYM e RSS.',
	'SEO_INSTALL_INTRO_BODY'	=> '<p>Stai per installare la MOD %1$s %2$s. Questo script di installazione attiverà la tua mappa sito GYM e RSS nel tuo phpBB.</p><p>Dopo l’installazione sara necessario un’appropriata configurazione nel tuo ACP.</p>
	<p><strong>Nota:</strong>Se è la prima volta che installi questa MOD, ti consigliamo vivamente di prendere il tempo per verificare le varie caratteristiche del modulo su un server locale prima di andare online.</p><br/>
	<p>Requisiti :</p>
	<ul>
	...
	'UN_SEO_INSTALL_INTRO'		=> 'Benvenuto nel programma di disinstallazione della MOD mappa sito GYM e RSS',
	...
	'SEO_LICENCE_BODY'	=> 'la MOD phpBB SEO GYM Sitemaps e RSS è realizzata sotto licenza GNU LESSER GENERAL PUBLIC LICENSE.',
