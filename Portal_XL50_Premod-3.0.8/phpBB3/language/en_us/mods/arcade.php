...
$lang = array_merge($lang, array(
	...
	'ARCADE_REPORT_ADDED'					=> 'Thank you for submitting a report about <strong>%s</strong>.<br /><br />This report will be reviewed by the administrator and appropriate action will be taken.  If more information is required the administrator will be in contact with you.',
	...
	'ARCADE_TEST_SCORE'						=> 'Your score for the game would have been recorded as <strong>%s</strong>, however no score will be saved because the category is in <strong>test mode</strong>. If you want to play %s again please click %shere%s. If you would like to go back to the category page please click %shere%s.',
	...
	'ARCADE_WELCOME_CHAMP'					=> '%s is the new %s champion!',
