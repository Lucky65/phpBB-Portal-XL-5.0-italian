...
$lang = array_merge($lang, array(
	...
	<ul>
		...
		<strong><span style="color:#009900;">CHMOD <span style="color:#FF0000;">755</span> into</span></strong> (Some servers require 0777 not 0755):<br />
	...
	'PORTAL_UPDATE_SUCCESS'			=> 'Congratulation!<br />The update of the database settings from the Portal XL is finished.<br /><br />You can now go on to install the remaining parts from the install instruction of Portal XL into your forum.<br /><br />Please delete the folder /install_portal/ from your forum root to avoid security issues.',
	...
	'PORTAL_UPDATE_NOT_POSSIBLE'	=> '<strong>Update not possible!</strong><br /><br />This release of Portal XL can not be updated as it seem to be on recommended state.<br /><br />Your current release carries version Portal XL 5.0 <strong>%1$s</strong>. <br /><br /><strong style="text-transform: uppercase;">Note:</strong> If you are unsure which Portal XL 5.0 Premod version you use please proceed to tab "<a href="index.php?mode=update">UPDATE</a>" to apply the latest database changes.',
