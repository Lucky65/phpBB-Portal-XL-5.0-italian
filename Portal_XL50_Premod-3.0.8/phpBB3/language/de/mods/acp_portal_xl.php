...
/* not in use at moment
   'PORTAL_WORD_GRAPH_MAX_SIZE'              	=> 'Maximale Schriftgr&ouml;sse in Pixel',
   'PORTAL_WORD_GRAPH_MAX_SIZE_EXPLAIN'         => 'Setze maximale Wordgr&ouml;sse in Pixel f&uuml;r wordgraph.',
   'PORTAL_WORD_GRAPH_MIN_SIZE'              	=> 'Mindestschriftgr&ouml;sse in Pixel',
   'PORTAL_WORD_GRAPH_MIN_SIZE_EXPLAIN'         => 'Setze minimale Wordgr&ouml;sse in Pixel f&uuml;r wordgraph.',
*/
   ...
   'PORTAL_FORUMLIST_EXPLAIN'    				=> 'Zeige diesen block Ja/Nein? <br /> Showes forums of the site, condensed in a block as list.',
   ...
   'PORTAL_PICTURE_RESIZE'						=> 'Automatische Bildgr&ouml;ssen anpassen (pixel)',
   'PORTAL_PICTURE_RESIZE_EXPLAIN'				=> 'Passe die Bildgr&ouml;sse automatisch an, so dass Bilder im Portal optimiert werden.',
   
   // corrected/added since RC5 below
	'ACP_COUNTER_SETTINGS_EXPLAIN'	=> 'Einstellungen f&uuml; animierten digits IP tracking Z&auml;hler.',
	'ACP_COUNTER_DIGITS_SETTINGS'	=> 'Z&auml;hler digits Einstellungen',
	'ACP_COUNTER_DISPLAY_SETTINGS'	=> 'Z&auml;hler display Einstellungen',
	'ACP_COUNTER_IP_SETTINGS'		=> 'Z&auml;hler IP blocking Einstellungen',

	'COUNTER_DIGITS_PATH'				=> 'Digits Pfad',
	'COUNTER_DIGITS_PATH_EXPLAIN'		=> 'Pfad zu den digits innerhalb Deines phpBB-Root, z.B. <samp>images/counter/digits</samp>',
	'COUNTER_DIGITS_ANI_PATH'			=> 'Pfad zu den animierten Digits',
	'COUNTER_DIGITS_ANI_PATH_EXPLAIN'	=> 'Pfad zu den animierten Digits inner deines phpBB-Root, z.B. <samp>images/counter/digits_ani</samp>',
	'COUNTER_DIGITS_NUMBER'				=> 'Anzahl der digits',
	'COUNTER_DIGITS_NUMBER_EXPLAIN'		=> 'Anzahl der digits die in deinem Z&auml;hler angezeigt werden',
	'COUNTER_DIGITS_WIDTH'				=> 'Digits breite',
	'COUNTER_DIGITS_WIDTH_EXPLAIN'		=> 'Die Breite Deiner digits',
	'COUNTER_DIGITS_HEIGHT'				=> 'Digits H&ouml;he',
	'COUNTER_DIGITS_HEIGHT_EXPLAIN'		=> 'Die H&ouml;he Deiner digits',
	'COUNTER_DISPLAY_IMAGE'				=> 'Angezeigt als Bild',
	'COUNTER_DISPLAY_NONE'				=> 'Keine Anzeige',
	'COUNTER_DISPLAY_STATS'				=> 'Zeige Z&auml;hler-Statistik',
	'COUNTER_DISPLAY_STATS_EXPLAIN'		=> 'Erlaubt das Anzeigen der Z&auml;hler-Statistiken',
	'COUNTER_DISPLAY_TEXT'				=> 'Anzeigen als Text',
	'COUNTER_BLOCK_IP'					=> 'Erlaube blocking IP',
	'COUNTER_BLOCK_IP_EXPLAIN'			=> 'Erlaubt tracking/blocking IP Adressen aus dem Z&auml;hler. Diese Option stellt sicher, das der Z&auml;hler richtig funktioniert: Durch Browser refresh wirds keine Z&auml;hlung geben innerhalb der blockierten Zeit.',
	'COUNTER_BLOCK_TIME'				=> 'IP blocking Zeit',
	'COUNTER_BLOCK_TIME_EXPLAIN'		=> 'Zeit in Sekunden f&uuml;r das tracking/blocking von allen IP-Adressen.',
	'COUNTER_IP_LOGFILE'				=> 'IP log Datei',
	'COUNTER_IP_LOGFILE_EXPLAIN'		=> 'Pfad zur IP log Datei innerhalb Deines Root, z.B. <samp>images/counter/ip.txt</samp>. Required if you enabled Allow blocking IP option.',

	'SELECT_COUNTER_DISPLAY_MODE'			=> 'Z&auml;hler Anzeige Modus',
    'SELECT_COUNTER_DISPLAY_MODE_EXPLAIN'   => 'W&auml;hle den Anzeige Modus f&uuml;r den Z&auml;hler. <br /><strong>Merke</strong>: Du musst <strong>immer</strong> auf click/activate: <strong>Anzeige als Bild</strong> oder: <strong>anzeige als Text</strong> Klicken, bevor &auml;nderungen gemacht oder gesichert werden.',

    'PORTAL_SHOW_LAST_NEWS'               	=> 'Sortiervorschriften f&uuml;r NEWS-Mitteilungen im Portal',
    'PORTAL_SHOW_LAST_NEWS_EXPLAIN'       	=> 'JA = Letzte Mitteilung/Antwort zuerst <br />NEIN = ERstes Thema zuerst.',

	// corrected/added since RC7 
    'PORTAL_SHOW_AJAX_USERINFO'               	=> 'Ajax user info',
    'PORTAL_SHOW_AJAX_USERINFO_EXPLAIN'       	=> 'Anzeige von ajax user info JA/NEIN?',
    'PORTAL_SHOW_TOPIC_HOVER_PREVIEW'           => 'Themen hover Vorschau',
    'PORTAL_SHOW_TOPIC_HOVER_PREVIEW_EXPLAIN'   => 'Anzeige Themen hover Vorschau JA/NEIN?',
    'PORTAL_SHOW_TOOL_TIPS'           			=> 'Board breiten tool tips',
    'PORTAL_SHOW_TOOL_TIPS_EXPLAIN'   			=> 'Anzeige der board Breiten tool tips JA/NEIN?',
    'PORTAL_SHOW_THANKS'           			    => 'Thank Post',
    'PORTAL_SHOW_THANKS_EXPLAIN'   			    => 'Aktiviere Thank Post JA/NEIN?',
	...
	// pagination 
    'ACP_PORTAL_ANNOUNCE_PAG_SETTINGS' => 'Ank&uuml;ndigungs Seitenumbrucheinstellungen',
    'ACP_PORTAL_NEWS_PAG_SETTINGS'     => 'Neuigkeiten Seitenumbrucheinstellungen',

    'PORTAL_PAG_REPOSITORY'            => 'Artikel Repository',
    'PORTAL_PAG_REPOSITORY_EXPLAIN'    => 'Zeige Seitenumbruch JA/NEIN? <br /><br />Wenn aktiviert, dann werden die Seitennummern unter dem letzten Artikel im Block angezeigt.',
    'PORTAL_PAG_PERMISSIONS'           => 'Seitenumbruchberechtigungen',
    'PORTAL_PAG_PERMISSIONS_EXPLAIN'   => 'Erlaube Berechtigungen JA/NEIN?',
    'PORTAL_PAG_SHOW_ALL'              => 'Zeige alle Arten von Nachrichten',
    'PORTAL_PAG_SHOW_ALL_EXPLAIN'      => 'Zeige alle Nachrichten JA/NEIN? <br /><br />Alle Arten von Nachrichten, wie Ank&uuml;ndigungen, Globale Ank&uuml;ndigungen, angeheftet und normal werden in der Neuigkeitskategorie mitgez&auml;hlt. Im Ank&uuml;ndigungsbereich werden nur die Globalen Ank&uuml;ndigungen und Ank&uuml;ndigungen gez&auml;hlt.',
