...
Scrollable Text.
	...
	array(
		0 => '<img src="data:image/gif;base64,R0lGODlhCwALAIABAP8AAP///yH5BAEAAAEALAAAAAALAAsAAAIRjI+pB7DW2oox0cquxfv5bxQAOw==" width="10" height="10" alt="" border="0" /> META Tags Settings',
		1 => 'These tags will allow you to give a description of your website to the search engine.<br />
This will allow the search engine to index your site better.<br />
Furthermore, these tags allow other options such as automatic redirect to another URL:<br /><br />
		<ul>
		<li><strong>Redirection Time (sec):</strong> Specifies a delay in seconds before the browser automatically redirect the document to an URL specified. The number before the URL is the delay in seconds which the browser will "pause" before the redirect is performed. Leave blank for No automatically redirection.</li>
		<li><strong>Redirection Adress (URL):</strong> Specifies a URL the browser automatically redirect the document to after above specifyed redirection time. Leave blank for No automatically redirection!</li>
		<li><strong>META Refresh:</strong> Specifies a delay in seconds before the browser automatically reloads the document. The number is the delay in seconds which the browser will "pause" before the refresh is performed. Enter a number in seconds. Leave blank for No automatically refresh!</li>
		<li><strong>META Pragma:</strong> Prohibit the record of the page in the cache memory of the browser. - To use this tag, enter no-cache, if not, left empty.</li>
		<li><strong>META Keywords:</strong> Function: Indicate to the search engines the key words related with your site.
            <br />- Maximum number of characters: 1000 or 100 key words.
            <br />- In the number of characters, do not forget to count the accentuated letters once coded in HTML. For example the letter "�", coded &à in HTML counts for eight characters.
            <br />- You should not repeat several times the same key word (the search engines do not like it).
            <br />- The key words are separate by a comma, a space or a comma and a space, it is your choice.</li>
		<li><strong>META Description:</strong> Description of your site.
            <br />- Maximum number of characters: 200
            <br />- Avoid the accents, on certain engines they are not taken into account.</li>
		<li><strong>META Author:</strong> Allows identification of the site author.
            <br />- Put the first name into tiny, followed by the family name in capital letter.
            <br />- If you wish, you can put several authors separated by a comma.</li>
		<li><strong>META Identifier-url:</strong> Makes possible to specify the URL.
            <br />- Enter the URL of your home page.
            <br />- You must specify only one URL.</li>
		<li><strong>META Reply-to:</strong> Allows to specify the email of the webmaster. It is preferable to put only one address.</li>
		<li><strong>META Revisit-after:</strong> Allows you to specafiy the number of days before the spider (robot of the engine) will index your site. - 15 days" or "30 days" are the best options.</li>
		<li><strong>META Category:</strong> Allows to specify the category of your site. Used by certain engines which give a classification by category.</li>
		<li><strong>META Copyright:</strong> Typically an unqualified copyright statement.
            <br />- You can include copyright, trademarks, patents, or other information here pertaining to your intellectual property.</li>
		<li><strong>META Generator:</strong> Typically the name and version number of a publishing tool used to create the page.
            <br />- Could be used by tool vendors to assess market penetration.
            <br />- Same tags as meta publisher.</li>
		<li><strong>META Robots:</strong> Controls search engine robots on a per-page basis.
            <br />- <strong>all</strong> = The bot index all the site (by default)
            <br />- <strong>none</strong> = The bot do not index your site at all
            <br />- <strong>index</strong> = your page is indexed
            <br />- <strong>noindex</strong> = Your page is\'nt indexed but the bot will follow the link of your page
            <br />- <strong>follow</strong> = The bot take note of your the link on your page for indexing them after.
            <br />- <strong>nofollow</strong> = The bot do not index the link on your page.
            <br />- <strong>noodp</strong> = Opting Out of Open Directory Listings for Webmasters (Live Search Microsoft). This tells the MSN search bot not to use the DMOZ site snippet, only MSN ignores ODP content for your page.</li>
		<li><strong>META Distribution:</strong> There are three classifications of distribution of your web content:
            <br />- <strong>Global</strong> (the entire web)
            <br />- <strong>Local</strong> (reserved for the local IP block of your site)
            <br />- <strong>IU</strong> (Internal Use, not for public distribution).</li>
		<li><strong>META Date-creation-yyyy:</strong> Creation year of your site eg. 2009.</li>
		<li><strong>META Date-creation-mm:</strong> Creation month of your site eg. 04.</li>
		<li><strong>META Date-creation-dd:</strong> Creation day of your site eg. 12.</li>
		<li><strong>META Date-revision-yyyy:</strong> Creation year of your site eg. 2009.</li>
		<li><strong>META Date-revision-mm:</strong> Creation month of your site eg. 08.</li>
		<li><strong>META Date-revision-dd:</strong> Creation day of your site eg. 21.</li>
		</ul>'
	),
	array(
