...
*
* @package language
* @version $Id: board.php 514 2010-11-13 22:22:22Z philippk $
...
$lang = array_merge($lang, array(
	...
	'VISUAL_CONFIRM_REFRESH_EXPLAIN'		=> 'Erlaubt den Benutzern, eine neuen Anti-Spam-Bot-Aufgabe anzufordern, wenn sie sie bei der Registrierung nicht lösen können. Nicht alle Plugins unterstützen diese Option.',
));
...
// AdvancedBlockMOD 1.0.3						
	...
	'CHECK_DNSBL_EXPLAIN'			=> 'Wenn aktiviert, wird die IP-Adresse des Benutzers bei der Registrierung und bei der Beitragserstellung gegen DNSBL-Dienste geprüft. Diese Prüfung kann, abhängig von der Serverkonfiguration, etwas Zeit in Anspruch nehmen. Wenn Verzögerungen oder zu viele falsche Ablehnungen beobachtet werden, sollte diese Prüfung deaktiviert werden.',
// AdvancedBlockMOD 1.0.3						
	'CLASS_B'						=> 'A.B',
	'CLASS_C'						=> 'A.B.C',
	...
	'MAX_LOGIN_ATTEMPTS_EXPLAIN'	=> 'Nach dieser Anzahl fehlgeschlagener Anmeldungen muss der Benutzer bei der Anmeldung zusätzlich eine Anti-Spam-Bot-Aufgabe lösen.',
...
$lang = array_merge($lang, array(
   'ACP_FLAG_SETTINGS_EXPLAIN'  => 'Landesflaggen Einstellungen',
   'FLAGS_PATH'            		=> 'Landesflaggen Bilderpfad',
   'FLAGS_PATH_EXPLAIN'      	=> 'Pfad im phpBB root Verzeichnis, z.B. <samp>images/flags</samp>',
   'REQUIRE_FLAG'             	=> 'Ben&ouml;tigt Landesflaggen Feld',
   'REQUIRE_FLAG_EXPLAIN'       => 'User m&uuml;ssen ihre Landesflagge beim registrieren angeben.',
));

// Friend list on member view by DaMysterious
$lang = array_merge($lang, array(
	'ACP_PROFILE_FRIENDS'	=> 'Profilfreunde Einstellungen',
	'ACP_PROFILE_FRIENDS_EXPLAIN'	=> 'Profilfreunde Einstellungen',
	'ACP_FRIEND_SETTINGS'	=> 'Profilfreunde Mod',
	'ACP_NUM_FRIENDS'	=> 'Anzahl der Freunde pro Seite',
	'ACP_NUM_FRIENDS_EXPLAIN'	=> 'Maximale Anzahl der Freunde, die auf jeder Seite angezeigt werden',
	'ACP_FRIENDS_AV_SIZE'		=> 'Avatargr&ouml;ße',
	'ACP_FRIENDS_AV_SIZE_EXPLAIN'		=> 'Die Avatargr&ouml;ße der Anzeige sollte zwischen 20 - 150 liegen',
	'ACP_SC_AVATAR_EXPLAIN'		=> 'Beispiel : 25 w&uuml;rde die Gr&ouml;ße auf 25px x 25px setzen<br/> Setze auf 0, um keinen Avatar anzuzeigen',
	'TITLE_EXPLAIN'		=> 'Einstellungen f&uuml;r den Profilfreunde Mod.',
));

// AdvancedBlockMOD 1.0.3						
$lang = array_merge($lang, array(
	'CHECK_TZ'						=> 'Zeitzone auf ungültige Zone prüfen',
	'CHECK_TZ_EXPLAIN'				=> 'Wenn aktiviert, wird bei der Registrierung die Zeitzone des Benutzers auf außerirdische Zeitzonen mit den Werten -19 und +19 überprüft. Spammer benutzen oft die ersten oder letzten Optionen aus einem Dropdown-Menü. Ist diese Option aktiviert, werden während der Benutzerregistrierung am Anfang und am Ende des Dropdown-Menüs zwei unsinnige Werte angefügt.',
	'LOG_CHECK_DNSBL'				=> 'Aktiviere Blockprotokoll für DNSBL-Überprüfung',
	'LOG_CHECK_TZ'					=> 'Aktiviere Blockprotokoll für Zeitzonen-Überprüfung',
	'LOG_EMAIL_CHECK_MX'			=> 'Aktiviere Blockprotokoll für DNS MX-Überprüfung',
));
