...
*
* @package language
* @version $Id: common.php 515 2010-11-13 22:41:00Z philippk $
...
$lang = array_merge($lang, array(
	'PORTAL'								=> 'Portal',
   	...
   	'ACP_PORTAL'           					=> 'Portal',
   	'ACP_PORTAL_ADMIN'           			=> 'Allgemein',
   	'ACP_PORTAL_INFO'           			=> 'Allgemein',	
    'ACP_PORTAL_ANNOUNCE_INFO'  			=> 'Ank&uuml;ndigungen',
    'ACP_PORTAL_NEWS_INFO'      			=> 'News',
   	'ACP_PORTAL_RECENT_INFO'    			=> 'Neue Themen',	
   	'ACP_PORTAL_WORDGRAPH_INFO'				=> 'Wordgraph',
    'ACP_PORTAL_PAYPAL_INFO'        		=> 'Paypal',	
    'ACP_PORTAL_ATTACHMENTS_NUMBER_INFO'    => 'Anh&auml;nge',
    'ACP_PORTAL_MEMBERS_INFO'               => 'Neue Mitglieder',
    'ACP_PORTAL_POLLS_INFO'                 => 'Umfragen',	
    'ACP_PORTAL_BOTS_INFO'                  => 'Besuchende Bots',
    'ACP_PORTAL_MOST_POSTER_INFO'           => 'Top Poster',
    'ACP_PORTAL_RANDOM_INFO'                => 'zuf&auml;llige Banner',
	...
	'ACP_MANAGE_PORTAL'						=> 'Verwalte Portal',
	...
	'ACP_MANAGE_BLOCKS'						=> 'Verwalte Portal Blocks',
	...
	'ACP_PORTAL_BLOCKS_INDEX'				=> 'Index Blocks',
	'ACP_MANAGE_INDEX_BLOCKS'				=> 'Verwalte Index Blocks',

	// Portal XL portal menu //
   	'ACP_PORTAL_CAT_MENUS'           		=> 'Men&uuml;s',
   	'ACP_PORTAL_ADMIN_MENUS'           		=> 'Men&uuml;s',
	'ACP_PORTAL_MENU'						=> 'Men&uuml;s',
	...
	// Portal XL portal banners vertical //
   	'ACP_PORTAL_CAT_BANNERS_VE'          		=> 'Banner vertikal',
   	'ACP_PORTAL_ADMIN_BANNERS_VE'           	=> 'Banner vertikal 130x600',
	'ACP_PORTAL_BANNERS_VE'						=> 'Banner vertikal',
	...
	'ACP_PORTAL_FORUMADDS'						=> 'Forum Ad\'s',
	...
	'PORTAL_LOG_INSTALL_PORTAL'	=> '<strong>Portal XL installiert</strong>',
...
$lang = array_merge($lang, array(
	'ACP_COUNTER_SETTINGS'	=> 'Z&auml;hler Einstellungen',
	'COUNTER_STARTED'		=> 'Z&auml;hler gestartet',
	'HITS_PER_DAY'			=> 'Treffer pro Tag',
	'LOG_CONFIG_COUNTER'	=> '<strong>Z&auml;hler Einstellungen hinzugef&uuml;gt</strong>',
	'LOG_RESET_COUNTER'		=> '<strong>Z&auml;hler Reset: Datum, Zeit und Treffer zur&uuml;ckgesetzt</strong>',
	'NUMBER_HITS'			=> 'Anzahl der Treffer',
	'RESET_COUNTER'			=> 'Z&auml;hler zur&uuml;cksetzen',
	'RESET_COUNTER_CONFIRM'	=> 'Bist Du sicher, das alle Z&auml;hlerwerte auf den Startwert gesetzt werden sollen?',
	'RESET_COUNTER_EXPLAIN'	=> 'Alle Werte wurden zur&uuml;ckgesetzt: starten Datum, Zeit und alle Treffer.',
));

// phpbb Calendar
$lang = array_merge($lang, array(
	'ACP_CALENDAR'            => 'Kalender',
	'ACP_CALENDAR_SETTINGS'            => 'Kalendereinstellungen',
	'ACP_CALENDAR_DELETE_EVENT_TYPE'   => 'L&ouml;sche Eventtyp',
	'ACP_CALENDAR_ETYPES'            => 'Bearbeite Kalender Eventtypen',
));

// Country Flags Version 3.0.6
$lang = array_merge($lang, array(
   'ACP_FLAG_SETTINGS'      => 'Landesflaggen Einstellungen',
   'ACP_FLAGS'            => 'Landesflaggen',
   'ACP_MANAGE_FLAGS'      => 'Verwalte Landesflaggen',
   'ACP_USER_FLAG'         => 'Landesflagge',
   'ACP_USER_COUNTRY_FLAG'   => 'Landesflagge',
   'LOG_CONFIG_FLAG'      => '<strong>Landesflaggen Einstellung ge&auml;ndert</strong>',
   'LOG_FLAG_ADDED'      => '<strong>Neue Landesflagge hinzugef&uuml;gt</strong><br />» %1$s (%2$s)',
   'LOG_FLAG_REMOVED'      => '<strong>Landesflagge hinzugef&uuml;gt</strong><br />» %1$s (%2$s)',
   'LOG_FLAG_UPDATED'      => '<strong>Landesflagge ge&auml;ndert</strong><br />» %1$s (%2$s)',
));

// Friend list on member view by DaMysterious
$lang = array_merge($lang, array(
	'ACP_FRIEND_SETTINGS' 	=> 'Profilfreunde',
	'ACP_PROFILE_FRIENDS' 	=> 'Profilfreunde Einstellungen',
));
...
*/
$lang = array_merge($lang, array(
	'ANNOUNCEMENT_TOPIC'	=> 'Release Ank&uuml;ndigung',
	...
	'RELEASE_ANNOUNCEMENT'	=> 'Ank&uuml;ndigungsthema',
...
$lang = array_merge($lang, array(
	...
	'ACP_BLOCK_LOGS_EXPLAIN'	=> 'Diese Liste zeigt alle Vorgänge, die bei der Zeitzonen-Überprüfung oder der DNS-Überprüfung, z.B. während der Benutzerregistrierung, durchgeführt wurden. Mit diesem Protokoll erhältst Du alle Informationen, um die Funktion dieser Überprüfungen kontrollieren zu können. Sofern du ausreichende Rechte hast, kannst du auch einzelne Einträge oder das ganze Protokoll löschen.<br /><strong>Die verschiedenen Protokolle müssen unter <em>SERVER-KONFIGURATION->Sicherheit</em> aktiviert sein!</strong>',
	'ACP_DNSBL'					=> 'DNSBL-Einstellungen',

	'LOG_CLEAR_BLOCK'			=> '<strong>Block-Protokoll gelöscht</strong>',
	'LOG_DNSBL'					=> '<strong>Benutzer während der DNSBL-Überprüfung blockiert.</strong><br />Für mehr Informationen schaue nach anderen Einträgen für die gleiche IP-Addresse.',
	'LOG_DNSBL_ADD'				=> '<strong>Neuer DNS Blacklist Eintrag erstellt</strong><br />» %s',
	'LOG_DNSBL_DELETE'			=> '<strong>DNS Blacklist Eintrag gelöscht</strong><br />» %s',
	'LOG_DNSBL_EDIT'			=> '<strong>DNS Blacklist Einstellungen geändert</strong><br />» %s',
	'LOG_DNSBL_FOUND'			=> '<strong>IP-Addresse eines Spammers während der DNSBL Überprüfung festgestellt.</strong><br />»Blacklist “<em>%s</em>”',
	...
	'LOG_DNSBL_REGISTER'		=> '<strong>Benutzer während der Registrierung durch DNSBL Überprüfung blockiert.</strong><br />Für mehr Informationen schaue nach anderen Einträgen für die gleiche IP-Addresse.',
	'LOG_DNSMX'					=> '<strong>Emailaddresse auf Grund DNS MX Überprüfung geblockt.</strong><br />»Domäne “<em>%s</em>”',
	'LOG_WRONG_TZ'				=> '<strong>Benutzer während der Zeitzonen-Überprüfung blockiert.</strong><br />»Zeitzone “<em>%s</em>”',
));
