...
$help = array(
	...
	array(
		...
		1 => 'Download the latest package.  Upload all the new files overwriting the old. Open the modx update files for the core and style edits and make the required changes.  Then run the included install script.  Choose the option to update to latest version and when complete move/rename/remove the install folder from your server.<br /><br />So for example if you are currently at 1.0.RC4 and want to update to 1.0.RC6:
<ul><li>Upload all the new files overwriting the old files</li>
<li>Look inside the contrib folder and follow <strong>update10RC4-10RC5.xml</strong> and then <strong>update10RC5-10RC6.xml</strong>.</li>
