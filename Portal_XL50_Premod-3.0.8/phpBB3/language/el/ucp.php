...
$lang = array_merge($lang, array(
    ...
    // Anti Bot Question
    $lang = array_merge($lang, array(
       'AB_QUESTION_ERROR'   => 'Η απάντηση στην Anti-Bot ερώτηση που προσθέσατε είναι λάθος. Παρακαλώ ελέγξτε την ερώτηση και προσπαθήστε πάλι .',
       'AB_NO_ANSWER'      => 'Καμία  απάντηση στην Anti-Bot ερώτηση δεν προστέθηκε.',
    ));

// phpbb Calendar Version 0.1.0
$lang = array_merge($lang, array(
	'DISPLAY_EVENTS_DAYCOUNT' => 'Πόσες μέρες στο μέλλον θέλετε να εμφανίσετε?',
	'UCP_MAIN_CALENDAR_MYEVENTS' => 'Διαχείριση των γεγονότων μου',
	'UCP_MAIN_CALENDAR_REGISTRATION'=> 'Διαχείριση εγγραφών γεγονότων',
));
