...
*
* @package language
* @version $Id: install.php 10837 2010-11-06 18:00:14Z git-gate $
...
$lang = array_merge($lang, array(
	...
	'DB_HOST_EXPLAIN'			=> 'Το DSN είναι συντομογραφία για Data Source Name και είναι σχετικό μόνο για εγκαταστάσεις ODBC. Για την PostgreSQL, χρησιμοποιήστε localhost για να συνδεθείτε τοπικά στον κεντρικό υπολογιστή για UNIX domain υποδοχέα και 127.0.0.1 για σύνδεση μέσω TCP.',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'Όλα τα αρχεία είναι ενημερωμένα στην τελευταία έκδοση του phpBB. Τώρα πρέπει να <a href="../ucp.php?mode=login&amp;redirect=adm/index.php%3Fi=send_statistics%26mode=send_statistics">συνδεθείτε στο σύστημα</a> και να ελέγξετε αν όλα λειτουργούν καλά. Μην ξεχάσετε να διαγράψετε, μετονομάσετε ή μετακινήσετε τον φάκελο εγκατάστασης (install)!',
