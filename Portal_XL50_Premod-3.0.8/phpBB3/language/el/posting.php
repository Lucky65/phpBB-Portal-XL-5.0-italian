...
$lang = array_merge($lang, array(
	'BBCODE_TABLE_HELP'		  	=> 'Δημιουργία πίνακα',
	'BBCODE_FONTCOLOR_HELP'		=> 'Γραμματοσειράς χρώμα',
	'BBCODE_FONTSIZE_HELP'		=> 'Γραμματοσειράς μέγεθος',
	'BBCODE_FONTFAMILY_HELP'	=> 'Γραμματοσειράς οικογένεια', 
));
