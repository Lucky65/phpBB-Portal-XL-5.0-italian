...
$lang = array_merge($lang, array(
 ...
 'ACP_PORTAL_COLLUMN_WIDTH_SETTINGS'
   => 'Ρυθμίσεις πλάτους αριστερής και δεξιάς στήλης',	
...
*/
 ...
 'PORTAL_SCROLL_MESSAGE_INTRO_EXPLAIN'
 				=> 'Εδώ μπορείτε να προσθέσετε/αλλάξετε το κυλιόμενο κείμενο. Επιτρέπονται έως 1000 χαρακτήρες, html κώδικας, τα cookies είναι ενεργοποιημένα! Το κείμενο που υπερβαίνει αυτό το όριο θα διαγράφετε αυτόματα.',
 ...
 'VIEWING_PORTAL'								=> 'Βλέπει την αρχική σελίδα',
  ...
  'PORTAL_SHOW_LAST_NEWS_EXPLAIN'       	=> 'Ναι = Τελευταία δημοσίευση/απάντηση πρώτη <br />Όχι = Πρώτο θέμα πρώτο.',
        ...
        'PORTAL_SHOW_AJAX_USERINFO'                  => 'Ajax Πληροφορίες μέλους',
        'PORTAL_SHOW_AJAX_USERINFO_EXPLAIN'          => 'Προβολή  ajax πληροφορίες μέλους Ναι/Όχι?',
        'PORTAL_SHOW_TOPIC_HOVER_PREVIEW'           => 'Προεπισκόπηση αιωρούμενο θέματος <strong>Topic hover</strong> ',
        'PORTAL_SHOW_TOPIC_HOVER_PREVIEW_EXPLAIN'   => 'Προβολή προεπισκόπησης αιωρούμενο θέματος Ναι/Όχι?',
        ...
        'PORTAL_SHOW_THANKS_EXPLAIN'                => 'Ενεργοποίηση Thank Post MOD Ναι/Όχι?',
