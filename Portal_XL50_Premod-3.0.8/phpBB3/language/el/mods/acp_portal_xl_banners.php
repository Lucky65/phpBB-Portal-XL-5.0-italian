...
$lang = array_merge($lang, array(   
	...
	'PARTNERS_IMG'			        => 'Δεσμός λογότυπου',
	'PARTNERS_IMG_EXPLAIN'			=> 'Δεσμός λογότυπου συνεργάτη, ο δεσμός είναι σχετικός με τον root κατάλογο της δημ. συζήτησης, π.χ. "http://www.ησελίδασας.com/"',
	'PARTNERS_LOGO'					=> 'Λογότυπο (88x31px)',
	...
	'BANNERS_IMG'			        => 'Δεσμός οριζοντίου λογότυπου 400x60px',
	'BANNERS_IMG_EXPLAIN'			=> 'Ο δεσμός του banner λογότυπου, ο δεσμός είναι σχετικός με τον root κατάλογο της δημ. συζήτησης, π.χ. "http://www.ησελίδασας.com/"',
	'BANNERS_LOGO'					=> 'Λογότυπου (400x60px)',
	...
	'BANNERS_IMG_HO'			    => 'Σύνδεσμος οριζόντιου λογότυπου 400x60px',
	'BANNERS_LOGO_HO'				=> 'Λογότυπο (400x60px)',

	'BANNERS_IMG_VE'			    => 'Σύνδεσμος κάθετου λογότυπου 130x600px',
	'BANNERS_LOGO_VE'				=> 'Λογότυπο (130x600px)',	
