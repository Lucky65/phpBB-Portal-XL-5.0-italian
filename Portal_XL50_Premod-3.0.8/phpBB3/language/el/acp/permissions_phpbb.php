...
$lang = array_merge($lang, array(
	'permission_cat'	=> array(
		...
		'downloads'		=> 'Πίνακας διαχείρισης μεταφορτώσεων',				
	),
...
// PM Spy mod
$lang = array_merge($lang, array(
	'acl_a_pm_spy'	=> array('lang'	=> 'Μπορεί να βλέπει ΠΜ μελών', 'cat' => 'misc'),
));

// Country Flags Version 3.0.6
$lang = array_merge($lang, array(
	'acl_a_flags'	=> array('lang' => 'Μπορεί να διαχειριστεί σημαίες κρατών', 'cat' => 'user_group'),
    'acl_a_country_flags'   => array('lang' => 'Μπορεί να διαχειριστεί σημαίες κρατών', 'cat' => 'misc'),	
));
