...
*
* @package language
* @version $Id: board.php 10874 2010-11-21 23:00:13Z git-gate $
...
$lang = array_merge($lang, array(
	...
	'WARNINGS_EXPIRE_EXPLAIN'		=> 'Ο αριθμός των ημερών, των οποίων μετά θα διαγραφούν οι προειδοποιήσεις από το προφίλ του μέλους.',
));
...
$lang = array_merge($lang, array(
	...
	'MIN_CHAR_LIMIT_EXPLAIN'		=> 'Ο ελάχιστος αριθμός  χαρακτήρων  που πρέπει τα μέλη  να εισαγάγουν στην δημοσίευση /προσωπικό μήνυμα.',
	'POSTING'						=> 'Δημοσίευση',
...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION_EXPLAIN'	=> 'Αυτό καθορίζει εάν τα μέλη έχουν άμεση πρόσβαση στην Δ. Συζήτησης ή εάν πρώτα απαιτείται επιβεβαίωση. Μπορείτε επίσης να απενεργοποιήσετε εντελώς τις εγγραφές.',
	...
	'ACC_ADMIN'					=> 'Κατά Διαχειριστή',
	'ACC_DISABLE'				=> 'Απενεργοποίηση',
	'ACC_NONE'					=> 'Κανένας',
	'ACC_USER'					=> 'Κατά μέλος',
...
// AdvancedBlockMOD 1.0.3						
	...
	'MAX_LOGIN_ATTEMPTS'			=> 'Μέγιστος αριθμός άκυρων συνδέσεων',
	'MAX_LOGIN_ATTEMPTS_EXPLAIN'	=> 'Μετά από αυτόν τον αριθμό άκυρων προσπαθειών σύνδεσης, το μέλος πρέπει να επιβεβαιώσει την σύνδεσή του προσθέτοντας έναν οπτικό κώδικα επιβεβαίωσης..',
...
$lang = array_merge($lang, array(
    ...
    // Anti Bot Question
    $lang = array_merge($lang, array(
       'AB_ANSWER'            => 'Anti-Bot Απάντηση',
       'AB_ANSWER_EXPLAIN'      => 'Αυτό είναι η κύρια απάντηση για την ερώτηση.',
       'AB_ANSWER_2'         => 'Anti-Bot δεύτερη ερώτηση',
       'AB_ANSWER_2_EXPLAIN'   => 'Εδώ μπορείτε να προσθέσετε μια δεύτερη απάντηση, μια καλή ιδέα εάν χρησιμοποιείτε μια ερώτηση που απαιτεί απάντηση με αριθμούς.',
       'AB_QUESTION_MOD'      => 'Anti-Bot Ερώτηση',
       'AB_QUESTION'         => 'Anti-Bot Ερώτηση',
       'AB_QUESTION_EXPLAIN'   => 'Αυτό είναι η ερώτηση που ένα μέλος πρέπει να απαντήσει για να εγγραφεί.',
       'ABQ_ENABLE'         => 'Ενεργοποίηση Anti-Bot ερώτηση',
       'ABQ_ENABLE_EXPLAIN'   => 'Ενεργοποίηση της Anti-Bot ερώτησης για τις εγγραφές.',
    ));


// Country Flags Version 3.0.6
$lang = array_merge($lang, array(
	'ACP_FLAG_SETTINGS_EXPLAIN'	=> 'Σημαίες κρατών ρυθμίσεις',
	'FLAGS_PATH'				=> 'Σημαίες κρατών εικόνες διαδρομή',
	'FLAGS_PATH_EXPLAIN'		=> 'Η διαδρομή  στον κύριο φάκελο phpBB, π.χ. <samp>images/flags</samp>',
	'REQUIRE_FLAG' 				=> 'Υποχρεωτικό πεδίο σημαίας κράτους',
	'REQUIRE_FLAG_EXPLAIN' 		=> 'Υποχρεώνει  τα μέλη να επιλέξουν την σημαία χώρας κατά την εγγραφή.',
));

// Friend list on member view by DaMysterious
$lang = array_merge($lang, array(
   'ACP_PROFILE_FRIENDS'         => 'Προφίλ φίλων ρυθμίσεις',
   'ACP_PROFILE_FRIENDS_EXPLAIN'   => 'Προφίλ φίλων ρυθμίσεις',
   'ACP_FRIEND_SETTINGS'         => 'Προφίλ φίλων μοντ',
   'ACP_NUM_FRIENDS'            => 'Προβολή φίλων ανά σελίδα',
   'ACP_NUM_FRIENDS_EXPLAIN'      => 'Μέγιστος αριθμός φίλων που θα εμφανίζονται ανά σελίδα',
   'ACP_FRIENDS_AV_SIZE'         => 'Άβαταρ μέγεθος',
   'ACP_FRIENDS_AV_SIZE_EXPLAIN'   => 'Το μέγεθος του άβαταρ που θα εμφανίζεται πρέπει να είναι μεταξύ 20 - 100 εικονοστοιχείων, προτείνετε 80 εικονοστοιχεία',
   'ACP_SC_AVATAR_EXPLAIN'         => 'Παράδειγμα: 25 θα θέσει το μέγεθος 25 εικονοστοιχεία x 25 εικονοστοιχεία  <br/> Για να απενεργοποιήσετε τα άβαταρ θέστε αυτό σε  0',
   'TITLE_EXPLAIN'               => 'Ρυθμίσεις για την λίστα φίλων στην προβολή μέλους.',
));
...
$lang = array_merge($lang, array(
	'BIRTHDAY_EMAILS'				=> 'Αποστολή ε-μαιλ γενεθλίων',
	'BIRTHDAY_EMAILS_EXPLAIN'		=> 'Αποστολή ε-μαιλ γενεθλίων στο μέλος που έχει γενέθλια',
));
