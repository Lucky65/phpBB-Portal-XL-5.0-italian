...
$lang = array_merge($lang, array(
  ...
  'SMILIES_CONFIG'                  => 'Ρυθμίσεις smiley',
	...
	'SMILIE_NO_CODE'			=> 'Τα  smilie “%s”  έχουν αγνοηθεί, επειδή κανένας κώδικας δεν προστέθηκε.',
	'SMILIE_NO_EMOTION'			=> 'Τα smilie “%s” έχουν αγνοηθεί, επειδή καμία περιγραφή δεν προστέθηκε.',	
...
// Disallow Usernames
$lang = array_merge($lang, array(
	'ACP_DISALLOW_EXPLAIN'	=> 'Εδώ μπορείτε να ελέγξετε τα ονόματα μελών που δεν επιτρέπετε να χρησιμοποιηθούν. Τα απαγορευμένα ονόματα μελών επιτρέπετε να περιέχουν έναν χαρακτήρα μπαλαντέρ *. Παρακαλώ σημειώστε ότι δεν έχετε την άδεια για να καθορίσετε οποιοδήποτε όνομα μέλους που έχει καταχωρηθεί ήδη, πρέπει πρώτα να διαγράψετε αυτό το όνομα και μετά να το απαγορεύσετε.',
	...
	'DISALLOWED_ALREADY'		=> 'Το όνομα που εισαγάγατε δεν μπορεί να απαγορευθεί. Είτε επειδή υπάρχει στον κατάλογο ή στον κατάλογο λογοκριτών λέξεων, ή ταιριάζει με το όνομα ενός μέλους που είναι ήδη εγγεγραμμένο.',
