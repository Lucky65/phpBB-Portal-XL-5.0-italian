...
$lang = array_merge($lang, array(
	...
	'RETAIN_POSTS'			=> 'Διατήρηση δημοσιεύσεων &amp; αναρτήσεις μπλοκ',
	'DELETE_BLOGS'				=> 'Διαγραφή μπλοκ αναρτήσεις',
	'DELETE_POSTS_AND_BLOGS'	=> 'Διαγραφή δημοσιεύσεων &amp; αναρτήσεις μπλοκ',
