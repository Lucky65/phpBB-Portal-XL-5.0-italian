...
$help = array(
 ...
 βοήθεια.',
	...
	array(
	0 => 'Που μπορώ να βρω τις μεταφορτώσεις?',
	1 => 'Σύνδεσμο για τις μεταφορτώσεις μπορείτε να βρείτε στον πλοηγό του ευρετηρίου ή στον πλοηγό της αρχικής. Άμεσος σύνδεσμος: [<a href="' . append_sid("{$phpbb_root_path}downloads.$phpEx") . '">Μεταφορτώσεις</a>]'
	),
	array(
	0 => 'Τι σημαίνει ' . $user->img('dl_blue') . '?',
	1 => 'Δεν μπορεί να γίνει μεταφόρτωσει. Η κίνηση  δεδομένων που έχει θέσει ο διαχειριστής σε αυτή την κατηγορία για αυτόν τον μήνα έχει περάσει το επιτρεπτό όριο.'
	),
	array(
	0 => 'Τι σημαίνει ' . $user->img('dl_red') . '?',
	1 => 'Δεν είναι δυνατή η μεταφόρτωση. Αυτό μπορεί να οφείλετε:<br />- Η μεταφόρτωση δεν επιτρέπεται από τον διαχειριστή.<br />- Το μέλος δεν έχει συνδεθεί και μόνο εγγεγραμμένα μέλη έχουν πρόσβαση στις μεταφορτώσεις.<br />- Το μέλος έχει εξαντλήσει την κίνηση δεδομένων μεταφόρτωσης για αυτό το αρχείο.<br />- Ο διαχειριστής έχει θέσει ένα όριο δημοσιεύσεων για να χρησιμοποιήσετε τις μεταφορτώσεις.<br />- Η κίνηση δεδομένων έχει εξαντληθεί για αυτόν τον μήνα.'
	),
	array(
	0 => 'Τι σημαίνει ' . $user->img('dl_grey') . '?',
	1 => 'Εξωτερική πηγή. Η μεταφόρτωση θα ξεκινήσει από έναν εξωτερικό κεντρικό υπολογιστή. Αυτό θα εμφανιστεί ως ' . $user->img('dl_green') . '. Η κίνηση του μέλους και η ολική κυκλοφορία δεν θα μειωθεί.'
	),
	array(
	0 => 'Τι σημαίνει ' . $user->img('dl_white') . '?',
	1 => 'Όπως ' . $user->img('Dl_green') . ' η κυκλοφορία μελών δεν θα μειωθεί. Αλλά μόνο τα εγγεγραμμένα μέλη  μπορούν να μεταφορτώσουν δωρεάν. Η ολική κυκλοφορία θα μειωθεί.'
	),
	array(
	0 => 'Τι σημαίνει ' . $user->img('dl_yellow') . '?',
	1 => 'Μεταφόρτωση υπό ορισμένους περιορισμούς. Η μεταφόρτωση είναι δυνατή μόνο για τα εγγεγραμμένα μέλη. Το μέλος πρέπει να συνδεθεί. Το μέγεθος του αρχείου θα αφαιρεθεί από την κίνησή σας και  επίσης θα αφαιρεθεί από τη ολική κίνηση.'
	),
	array(
	0 => 'Τι σημαίνει' . $user->img('dl_green') . '?',
	1 => 'Ελεύθερη μεταφόρτωση. Μπορείτε να μεταφορτώσετε χωρίς να είστε εγγεγραμμένο μέλος. Αυτό το αρχείο μπορεί να μεταφορτωθεί από επισκέπτες. Δεν χρειάζεται να συνδεθείτε. Η κίνησή  σας δεν θα μειωθεί αλλά μόνο η ολική κυκλοφορία.'
	),
	array(
	0 => 'Γιατί δεν μπορώ να μεταφορτώσω κανένα αρχείο',
	1 => 'Αυτό μπορεί να οφείλεται σε διάφορους λόγους. Μπορείτε να δείτε εδώ ' . $user->img('dl_blue') . ' και ' . $user->img('dl_red')
	),
	array(
	0 => 'Πως και πότε ανανεώνετε η κίνησή μου στον λογαριασμό?',
	1 => 'Μετά από την πρώτη σύνδεση το μέλος θα πάρει χρονόσημο. Κάθε πρώτη ημέρα ενός μήνα που το μέλος θα συνδεθεί η κίνηση των μεταφορτώσεων ανανεώνετε. Ρωτήστε το διαχειριστή πόσο κίνηση θα πάρετε.'
	),
	array(
	0 => 'Θέλω να μεταφορτώσω ακόμη ένα αρχείο αλλά δεν μου έχει μείνει κίνηση?',
	1 => 'Σε αυτήν την περίπτωση ρωτήστε τον διαχειριστή. Μόνο αυτός μπορεί να αυξήσει την κυκλοφορία πριν τον επόμενο μήνα.'
	),
	array(
	0 => 'Πως μπορώ να κατατάξω μια μεταφόρτωση?',
	1 => 'Πίσω από κάθε μεταφόρτωση σε μια κατηγορία ή την άποψη πληροφοριών  θα βρείτε και την περιοχή της κατάταξης.<br />Πατώτας το  "Κατάταξη" ένα εγγεγραμμένο μέλος μπορεί να τατατάξει μια μεταφόρτωση με 1 βαθμό (πολύ κακό) εως 10 βαθμούς (πολύ καλό). Μπορείτε να κατατάξετε μια μεταφόρτωση μόνο μια φορά.'
	),
	array(
		0 => '--',
