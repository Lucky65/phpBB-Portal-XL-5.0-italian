...
$lang = array_merge($lang, array(
	...
	'DISPLAY_ON_INDEX'		=> 'Show in main categorie',
	'DISPLAY_ON_INDEX_DESC'	=> '',
	'DELETED'				=> 'The entry was deleted',
	'MCP_REPORT_TITLE'		=> 'Reported articles',
	'MCP_REPORT_EXPLAIN'	=> '',
	'REALY_DELETE'			=> 'Should the entry realy be deleded?',
	...
	'SUB_CATGEGORIES'		=> 'Subcategories',
	'SEARCH_CATEGORIE'		=> 'Search categorie',
	...
	'ARTICLE_TYPES_DESC'	=> 'In which article types you whant to search? Use the &lt;CTRL&gt; key to choose more that one type, to search in all types choose no type.',
	...
	'ARTICLE_POSTET'		=> 'Article poted',
	'AKTIVATE'				=> 'Activate',

	'BACK_ARTICLE'			=> 'Back to article',
	'BACK_KB'				=> 'Return to Knowledge Base',
	...
	'CATEGORIES_DESC'		=> 'In which categories you whant to search? Use the &lt;CTRL&gt; key to choose more that one categorie, to search in all categories choose no type.',
	...
	'CACHE_TIME_DESC'		=> 'Time for that types and categories will be cached',
	'SECONDS'				=> 'Seconds',
	'ACTIVATE_TYPES'		=> 'Use article types?',
	'ACTIVATE_TYPES_DESC'	=> 'Can you give a type for an article?',
	'UPDATE_POST'			=> 'Refresh post',
	'UPDATE_POST_DESC'		=> 'Should the post for the article be updated when article has been updated?',
	'POST_UPDATE_MESSAGE'	=> 'Article updated',
	'POST_ID'				=> 'ID of forums post',
	'ARTICLE_ADDED_AKTIV'	=> 'The artickle was subited to database and activated',
