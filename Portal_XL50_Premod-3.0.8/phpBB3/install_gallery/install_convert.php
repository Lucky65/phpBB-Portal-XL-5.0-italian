...
class install_convert extends module
{
	...
	*/
	function check_server_requirements($mode, $sub)
	{
		...
		$url = (!in_array(false, $passed) && $convert_prefix) ? append_sid("{$phpbb_root_path}install_gallery/index.$phpEx", "mode=$mode&amp;convert_prefix=$convert_prefix&amp;sub=create_table") : append_sid("{$phpbb_root_path}install_gallery/index.$phpEx", "mode=$mode&amp;sub=requirements");
	...
	*/
	function load_schema($mode, $sub)
	{
		...
		$template->assign_vars(array(
			...
			'L_SUBMIT'	=> $user->lang['NEXT_STEP'],
			'S_HIDDEN'	=> '',
			'U_ACTION'	=> append_sid("{$phpbb_root_path}install_gallery/index.$phpEx", "mode=$mode&amp;sub=in_progress&amp;convert_prefix=$convert_prefix"),
		));
	}
	...
	function convert_data($mode, $sub)
	{
		...
		switch ($step)
		{
			case 0:
				...
				$next_update_url = append_sid("{$phpbb_root_path}install_gallery/index.$phpEx", "mode=$mode&amp;sub=in_progress&amp;convert_prefix=$convert_prefix&amp;step=1");
			break;
			...
			case 1:
				...
				$next_update_url = append_sid("{$phpbb_root_path}install_gallery/index.$phpEx", "mode=$mode&amp;sub=in_progress&amp;convert_prefix=$convert_prefix&amp;step=2");
			break;
			...
			case 2:
				...
				$next_update_url = append_sid("{$phpbb_root_path}install_gallery/index.$phpEx", "mode=$mode&amp;sub=in_progress&amp;convert_prefix=$convert_prefix&amp;step=3&amp;personal_albums=$personal_albums");
			break;
			...
			case 3:
				...
				$next_update_url = append_sid("{$phpbb_root_path}install_gallery/index.$phpEx", "mode=$mode&amp;sub=in_progress&amp;convert_prefix=$convert_prefix&amp;step=4");
			break;
			...
			case 4:
				...
				$next_update_url = append_sid("{$phpbb_root_path}install_gallery/index.$phpEx", "mode=$mode&amp;sub=in_progress&amp;convert_prefix=$convert_prefix&amp;step=5");
			break;
			...
			case 5:
				...
				$next_update_url = append_sid("{$phpbb_root_path}install_gallery/index.$phpEx", "mode=$mode&amp;sub=in_progress&amp;convert_prefix=$convert_prefix&amp;step=6");
			break;
			...
			case 6:
				...
				$next_update_url = append_sid("{$phpbb_root_path}install_gallery/index.$phpEx", "mode=$mode&amp;sub=in_progress&amp;convert_prefix=$convert_prefix&amp;step=7");
			break;
			...
			case 7:
				...
				$next_update_url = append_sid("{$phpbb_root_path}install_gallery/index.$phpEx", "mode=$mode&amp;sub=in_progress&amp;convert_prefix=$convert_prefix&amp;step=8");
			break;
			...
			case 8:
				...
				$next_update_url = append_sid("{$phpbb_root_path}install_gallery/index.$phpEx", "mode=$mode&amp;sub=in_progress&amp;convert_prefix=$convert_prefix&amp;step=9");
			break;
			...
			case 9:
				...
				$next_update_url = append_sid("{$phpbb_root_path}install_gallery/index.$phpEx", "mode=$mode&amp;sub=advanced&amp;convert_prefix=$convert_prefix");
			break;
		}
