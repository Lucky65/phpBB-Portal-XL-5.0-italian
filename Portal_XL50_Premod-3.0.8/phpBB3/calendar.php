...
// Output the page
page_header($config['sitename'] . ' : ' . $user->lang['PAGE_TITLE']); // Page title, this language variable should be defined in the language file you setup at the top of this page.
