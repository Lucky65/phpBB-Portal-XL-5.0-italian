...
*
* @package phpBB3
* @version $Id: bbcode.php,v 1.1.1.1 2009/05/15 05:13:32 damysterious Exp $
...
/* Start Image RESIZE */
$img_resize = ( isset( $_SERVER['HTTP_USER_AGENT'] ) ) ? strtolower( $_SERVER['HTTP_USER_AGENT'] ) : '';
if (stristr($img_resize, "msie")) {
return '<a href="$1" class="highslide" onclick="return hs.expand(this)"><img resizemod="on" onload="rmw_img_loaded(this)" src="$1" alt="' . $user->lang['IMAGE'] . '" style="width: expression(this.width > 60 ? 475 : true);" /></a>';
} else {
return '<a href="$1" class="highslide" onclick="return hs.expand(this)"><img resizemod="on" onload="rmw_img_loaded(this)" src="$1" alt="' . $user->lang['IMAGE'] . '" /></a>';
}
/* End Image RESIZE */
...
//				'img'       => '<a href="$1" class="highslide" onclick="return hs.expand(this)"><img src="$1" resizemod="on" onload="rmw_img_loaded(this)" alt="' . $user->lang['IMAGE'] . '" /></a>', // resize of images including Highslide image management
				'img'       => $img_resize,
