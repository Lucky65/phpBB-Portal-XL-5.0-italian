...
*
* @package ucp
* @version $Id: ucp_arcade.php 716 2009-01-02 14:08:49Z JRSweets $
...
class ucp_arcade
{
	...
	{
		global $config, $db, $user, $auth, $auth_arcade, $template, $table_prefix, $phpbb_root_path, $phpEx;
	...
	function manage_settings()
	{
		...
		if ($arcade->config['send_arcade_pm'])
		{
			$data['user_arcade_pm'] = request_var('user_arcade_pm', (bool) $user->data['user_arcade_pm']);
		}
