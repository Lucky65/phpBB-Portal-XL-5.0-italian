...
function view_message($id, $mode, $folder_id, $msg_id, $folder, $message_row)
{
	...
	$template->assign_vars(array(
		...
		'FLAG_COUNTRY'		=> $user_info['flag_country'],
		'FLAG_CODE'			=> $user_info['flag_code'],
		'FLAG_IMG'			=> $user_info['flag_img'],
		// Country Flags Version 3.0.6
...
function get_user_information($user_id, $user_row)
{
	...
	// Country Flags Version 3.0.6
	get_user_flag($user_row['user_country_flag'], $user_row['flag_country'], $user_row['flag_code'], $user_row['flag_img'], $user_row['flag_img_src']);
	// Country Flags Version 3.0.6
