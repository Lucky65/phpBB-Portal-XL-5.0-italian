...
*
* @package phpBB3
* @version $Id: prime_post_revisions.php,v 1.1.1.1 2009/05/15 05:13:56 damysterious Exp $
...
*/
if (!defined('INCLUDES_PRIME_POST_REVISIONS'))
{
	define('INCLUDES_PRIME_POST_REVISIONS', true);
		...
		*/
		function prime_post_revisions(&$post_list, $forum_id = 0, $topic_id = 0, $post_id = 0)
		{
			...
			if ($remove_history = request_var('remove_history', 0))
			{
				...
				redirect(append_sid("{$phpbb_root_path}viewtopic.$phpEx?p=$post_id&f=$forum_id&display_history=true"));
			}
		}
