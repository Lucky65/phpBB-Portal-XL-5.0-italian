...
//-- end: Prime Quick Reply -------------------------------------------------//
			...
			case 'country_flag':
				$display_vars = array(
					...
					'vars'	=> array(
						...
						'country_flags_require'	=> array('lang' => 'REQUIRE_FLAG', 'validate' => 'bool', 'type' => 'radio:yes_no', 'explain' => true),
						'country_flags_path'	=> array('lang' => 'FLAGS_PATH', 'validate' => 'rpath',	'type' => 'text:30:255', 'explain' => true),
					)
				);
			break;
			// Country Flags Version 3.0.6
			...
			case 'profilefriends':
				$display_vars = array(
					'title'	=> 'ACP_FRIEND_SETTINGS',
					'vars'	=> array(
						'legend1'				=> 'ACP_PROFILE_FRIENDS',
						'number_friends'		=> array('lang' => 'ACP_NUM_FRIENDS', 'validate' => 'string', 'type' => 'text:5:3', 'explain' => true),
						'friend_avatar_size'	=> array('lang' => 'ACP_FRIENDS_AV_SIZE', 'validate' => 'string', 'type' => 'text:5:3', 'explain' => true),
					)
				);
			break;	
			// Friend list on member view by DaMysterious
