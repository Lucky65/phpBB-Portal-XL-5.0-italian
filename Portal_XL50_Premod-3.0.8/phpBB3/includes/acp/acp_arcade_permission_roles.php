...
*
* @package acp
* @version $Id: acp_arcade_permission_roles.php 240 2008-05-05 15:34:36Z jrsweets $
...
* @package acp
*/
class acp_arcade_permission_roles
{
	var $u_action;

	function main($id, $mode)
	{
		global $db, $user, $auth, $auth_arcade, $template, $table_prefix, $auth_arcade, $cache;
		...
		switch ($mode)
		{
			...
			case 'user_roles':
				$permission_type = 'arcade_';
				$this->page_title = 'ACP_ARCADE_USER_ROLES';
			break;
	...
	*/
	function display_auth_options($auth_options)
	{
		...
		auth_arcade_admin::build_permission_array($auth_options, $content_array, $categories, $key_sort_array);
