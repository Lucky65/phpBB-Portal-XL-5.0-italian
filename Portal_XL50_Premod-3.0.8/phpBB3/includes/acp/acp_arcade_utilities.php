...
*
* @package acp
* @version $Id: acp_arcade_utilities.php 812 2009-07-09 14:28:58Z JRSweets $
			...
			case 'view':
				...
				foreach ($row as $item)
				{
					$template->assign_block_vars('games', array(
						...
						'GAME_IMAGE'	=> ($item['game_image']) ? append_sid("{$phpbb_root_path}arcade.$phpEx", "img={$item['game_image']}") : '',
