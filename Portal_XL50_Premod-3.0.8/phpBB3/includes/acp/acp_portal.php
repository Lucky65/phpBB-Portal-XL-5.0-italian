         ...
         case 'portal':
            $display_vars = array(
               ...
               'vars'   => array(
                  ...
                  'portal_show_ajax_userinfo'    		=> array('lang' => 'PORTAL_SHOW_AJAX_USERINFO'        ,   'validate' => 'bool',   	'type' => 'radio:yes_no',   'explain' => true),
                  'portal_show_topic_hover_preview'    	=> array('lang' => 'PORTAL_SHOW_TOPIC_HOVER_PREVIEW'  ,   'validate' => 'bool',   	'type' => 'radio:yes_no',   'explain' => true),
                  'portal_show_tool_tips'    			=> array('lang' => 'PORTAL_SHOW_TOOL_TIPS'  		  ,   'validate' => 'bool',   	'type' => 'radio:yes_no',   'explain' => true),
				  'portal_show_thanks'             		=> array('lang' => 'PORTAL_SHOW_THANKS'               ,   'validate' => 'bool',     'type' => 'radio:yes_no',   'explain' => true),
				  'portal_show_bbcode_box'     			=> array('lang' => 'PORTAL_SHOW_BBCODE_BOX'      	  ,   'validate' => 'bool',     'type' => 'radio:yes_no',   'explain' => true),
				  'portal_show_zodiacs'     			=> array('lang' => 'PORTAL_SHOW_ZODIACS'	      	  ,   'validate' => 'bool',     'type' => 'radio:yes_no',   'explain' => true),
				  'portal_show_logo'     				=> array('lang' => 'PORTAL_SHOW_LOGO'	  			  ,   'validate' => 'bool',     'type' => 'radio:yes_no',   'explain' => true),
				  'portal_show_sitename'     			=> array('lang' => 'PORTAL_SHOW_SITENAME'	  		  ,   'validate' => 'bool',     'type' => 'radio:yes_no',   'explain' => true),
