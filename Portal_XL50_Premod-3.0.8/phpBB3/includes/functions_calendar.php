...
/**
* Begin additional Portal XL functions
*/
function calendar_display_center_month()
{
	...
	global $phpEx, $phpbb_root_path, $calling_page;
	...
	$center_prev_link = append_sid("{$phpbb_root_path}calendar.$phpEx", "calM=".$date['prev_month']."&amp;calY=".$date['prev_year'].$etype_url_opts);
	$center_next_link = append_sid("{$phpbb_root_path}calendar.$phpEx", "calM=".$date['next_month']."&amp;calY=".$date['next_year'].$etype_url_opts);

//  $calling_page = (!empty($_SERVER['PHP_SELF'])) ? $_SERVER['PHP_SELF'] : $_ENV['PHP_SELF'];
//	$center_prev_link = append_sid($calling_page, "calM=".$date['prev_month']."&amp;calY=".$date['prev_year'].$etype_url_opts);
//	$center_next_link = append_sid($calling_page, "calM=".$date['next_month']."&amp;calY=".$date['next_year'].$etype_url_opts);
	...
	for ($j = 1; $j < $number_days+1; $j++, $counter++)
	{
		...
		{
			$center_calendar_days['ADD_LINK'] = append_sid("{$phpbb_root_path}calendarpost.$phpEx", "mode=post&amp;calD=".$j."&amp;calM=".$date['month_no']."&amp;calY=".$date['year'].$etype_url_opts);
		}
		$center_calendar_days['DAY_VIEW_URL'] = append_sid("{$phpbb_root_path}calendar.$phpEx", "view=day&amp;calD=".$j."&amp;calM=".$date['month_no']."&amp;calY=".$date['year'].$etype_url_opts);
		$center_calendar_days['WEEK_VIEW_URL'] = append_sid("{$phpbb_root_path}calendar.$phpEx", "view=week&amp;calD=".$j."&amp;calM=".$date['month_no']."&amp;calY=".$date['year'].$etype_url_opts);
...
//        'CALENDAR_PREV_CENTER'         	=> '<a href=\''.$center_prev_link.'\'><img src="' . "{$phpbb_root_path}styles/" . $user->theme['imageset_path'] . '/imageset/mini_cal_icon_left_arrow.png" title="' . $user->lang['VIEW_PREVIOUS_MONTH'] . '" height="17" width="17" alt="' . $user->lang['VIEW_PREVIOUS_MONTH'] . '" /></a>',
//        'CALENDAR_NEXT_CENTER'         	=> '<a href=\''.$center_next_link.'\'><img src="' . "{$phpbb_root_path}styles/" . $user->theme['imageset_path'] . '/imageset/mini_cal_icon_right_arrow.png" title="' . $user->lang['VIEW_NEXT_MONTH'] . '" height="17" width="17" alt="' . $user->lang['VIEW_NEXT_MONTH'] . '" /></a>',      
		'CALENDAR_PREV_CENTER'			=> '<a href=\''.$center_prev_link.'\' title="' . $user->lang['VIEW_PREVIOUS_MONTH'] . '">&lt;&lt;</a>',
		'CALENDAR_NEXT_CENTER'			=> '<a href=\''.$center_next_link.'\' title="' . $user->lang['VIEW_NEXT_MONTH'] . '">&gt;&gt;</a>',
		...
		'FRIDAY'						=> $friday,
		'SATURDAY'						=> $saturday,
		'S_POST_ACTION_CENTER'			=> append_sid("{$phpbb_root_path}calendar.$phpEx", get_etype_post_opts() ),
	));
...
function calendar_display_mini_month()
{
	...
	//create next and prev links
	set_date_prev_next( "month" );
	$mini_prev_link = append_sid("{$phpbb_root_path}calendar.$phpEx", "calM=".$date['prev_month']."&amp;calY=".$date['prev_year'].$etype_url_opts);
	$mini_next_link = append_sid("{$phpbb_root_path}calendar.$phpEx", "calM=".$date['next_month']."&amp;calY=".$date['next_year'].$etype_url_opts);

//  $calling_page = (!empty($_SERVER['PHP_SELF'])) ? $_SERVER['PHP_SELF'] : $_ENV['PHP_SELF'];
//	$mini_prev_link = append_sid($calling_page, "calM=".$date['prev_month']."&amp;calY=".$date['prev_year'].$etype_url_opts);
//	$mini_next_link = append_sid($calling_page, "calM=".$date['next_month']."&amp;calY=".$date['next_year'].$etype_url_opts);
	...
	for ($j = 1; $j < $number_days+1; $j++, $counter++)
	{
		...
		if ( $auth->acl_gets('u_calendar_create_public_events', 'u_calendar_create_group_events', 'u_calendar_create_private_events') )
		{
			$mini_calendar_days['ADD_LINK'] = append_sid("{$phpbb_root_path}calendarpost.$phpEx", "mode=post&amp;calD=".$j."&amp;calM=".$date['month_no']."&amp;calY=".$date['year'].$etype_url_opts);
		}
		$mini_calendar_days['DAY_VIEW_URL'] = append_sid("{$phpbb_root_path}calendar.$phpEx", "view=day&amp;calD=".$j."&amp;calM=".$date['month_no']."&amp;calY=".$date['year'].$etype_url_opts);
		$mini_calendar_days['WEEK_VIEW_URL'] = append_sid("{$phpbb_root_path}calendar.$phpEx", "view=week&amp;calD=".$j."&amp;calM=".$date['month_no']."&amp;calY=".$date['year'].$etype_url_opts);
		...
		if ( $user_can_view_events )
		{
			...
			while ($row = $db->sql_fetchrow($result))
			{
				...
				$event_output['IMAGE'] = $available_etype_images[$row['etype_id']];
				$event_output['EVENT_URL'] = append_sid("{$phpbb_root_path}calendar.$phpEx", "view=event&amp;calEid=".$row['event_id'].$etype_url_opts);
				$event_output['NUMBER'] = $j;
				$event_output['DAY_VIEW_URL'] = append_sid("{$phpbb_root_path}calendar.$phpEx", "view=day&amp;calD=".$j."&amp;calM=".$date['month_no']."&amp;calY=".$date['year'].$etype_url_opts);
				$event_output['WEEK_VIEW_URL'] = append_sid("{$phpbb_root_path}calendar.$phpEx", "view=week&amp;calD=".$j."&amp;calM=".$date['month_no']."&amp;calY=".$date['year'].$etype_url_opts);
				...
				$template->assign_block_vars('mini_calendar_days.events', $event_output);
			}
			$db->sql_freeresult($result);
		}
	...
	$template->assign_vars(array(
		...
		'DAY_IMG'						=> $user->img('button_calendar_day', 'DAY'),
		'WEEK_IMG'						=> $user->img('button_calendar_week', 'WEEK'),
//        'CALENDAR_PREV_MINI'         	=> '<a href=\''.$mini_prev_link.'\'><img src="' . "{$phpbb_root_path}styles/" . $user->theme['imageset_path'] . '/imageset/mini_cal_icon_left_arrow.png" title="' . $user->lang['VIEW_PREVIOUS_MONTH'] . '" height="12" width="12" alt="' . $user->lang['VIEW_PREVIOUS_MONTH'] . '" /></a>',
//        'CALENDAR_NEXT_MINI'         	=> '<a href=\''.$mini_next_link.'\'><img src="' . "{$phpbb_root_path}styles/" . $user->theme['imageset_path'] . '/imageset/mini_cal_icon_right_arrow.png" title="' . $user->lang['VIEW_NEXT_MONTH'] . '" height="12" width="12" alt="' . $user->lang['VIEW_NEXT_MONTH'] . '" /></a>',      
		'CALENDAR_PREV_MINI'			=> '<a href="' . $mini_prev_link . '" title="' . $user->lang['VIEW_PREVIOUS_MONTH'] . '"><strong>&laquo;</strong></a>',
		'CALENDAR_NEXT_MINI'			=> '<a href="' . $mini_next_link . '" title="' . $user->lang['VIEW_NEXT_MONTH'] . '"><strong>&raquo;</strong></a>',
		'CALENDAR_VIEW_OPTIONS' 		=> $mode_sel_code.' '.$month_sel_code.' '.$day_sel_code.' '.$year_sel_code,
		'SUNDAY_MINI'					=> $sunday,
		'MONDAY_MINI'					=> $monday,
		...
		'S_POST_ACTION_MINI'			=> append_sid("{$phpbb_root_path}calendar.$phpEx", get_etype_post_opts() ),
	));
...
/**
* End additional Portal XL functions
*/
...
function calendar_display_day()
{
	...
	if( $hour_mode == 12 )
	{
		for( $i = 0; $i < 24; $i++ )
		{
			...
			$time_header['AM_PM'] = $user->lang['CAL_PM'];
			if( $i < 12 )
			{
				$time_header['AM_PM'] = $user->lang['CAL_AM'];
			}
