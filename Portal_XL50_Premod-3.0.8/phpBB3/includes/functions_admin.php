...
// phpBB Prime Trash Bin integration
...
//-- mod : log connections --------------------------------------------------------
//-- add	
				$log_data_ary = ($mode == 'connections' && strpos($row['log_operation'], 'SUCCESS_AUTO') !== FALSE) ? '<a href="' . append_sid($phpbb_root_path . $log_data_ary[0]) . '"' . $log_data_ary[0] . '>'. $log_data_ary[0] . '</a>' : $log_data_ary;
//-- end : log connections --------------------------------------------------------
