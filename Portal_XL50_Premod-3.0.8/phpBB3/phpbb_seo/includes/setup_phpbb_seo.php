...
class setup_phpbb_seo {
	...
	*/
	function init_phpbb_seo() {
		...
		$this->seo_url['calendar'] = $this->seo_url['calendar'] = array();
		$this->seo_ext['calendar'] = '/';
		$this->seo_ext['calendar'] = '.html';
		$this->seo_static['calendar'] = 'calendar';
		$this->rewrite_method[$this->seo_path['phpbb_urlR']]['calendar'] = 'calendar';
		
		$this->seo_url['downloads'] = $this->seo_url['downloads'] = array();
		$this->seo_ext['downloads'] = '/';
		$this->seo_ext['downloads'] = '.html';
		$this->seo_static['downloads'] = 'downloads';
		$this->rewrite_method[$this->seo_path['phpbb_urlR']]['downloads'] = 'downloads';
		
		$this->seo_url['arcade'] = $this->seo_url['arcade'] = array();
		$this->seo_ext['arcade'] = '/';
		$this->seo_ext['arcade'] = '.html';
		$this->seo_static['arcade'] = 'arcade';
		$this->rewrite_method[$this->seo_path['phpbb_urlR']]['arcade'] = 'arcade';
		...
		$this->seo_ext['album'] = '/';
		$this->seo_ext['pic'] = '.html';
		$this->seo_ext['ipic'] = '.jpg'; // could be empty
		$this->seo_ext['album_user'] = '/';
		...
		$this->seo_path['album_path']= $phpbb_root_path . GALLERY_ROOT_PATH;
		...
		$this->paginate_method['album'] = $this->seo_ext['album'] === '/' ? 'rewrite_pagination_page' : 'rewrite_pagination';
		$this->paginate_method['album_user'] = $this->seo_ext['album_user'] === '/' ? 'rewrite_pagination_page' : 'rewrite_pagination';
		$this->paginate_method['pic'] = $this->seo_ext['pic'] === '/' ? 'rewrite_pagination_page' : 'rewrite_pagination';
		...
		$this->phpbb_filter['album']['search'] = array('sk' => 't', 'sd' => 'd', 'st' => 0);
		// Gallery Mod
	...
	*/
	...
	function calendar() {
		$this->path = $this->seo_path['phpbb_urlR'];
		if ($this->filter_url($this->seo_stop_vars)) {
			$this->url = $this->seo_static['calendar'] . $this->seo_ext['calendar'];
			return;
		}
		$this->path = $this->seo_path['phpbb_url'];
		return;
	...
	function downloads() {
		$this->path = $this->seo_path['phpbb_urlR'];
		if ($this->filter_url($this->seo_stop_vars)) {
			$this->url = $this->seo_static['downloads'] . $this->seo_ext['downloads'];
			return;
		}
		$this->path = $this->seo_path['phpbb_url'];
		return;
	...
	function arcade() {
		$this->path = $this->seo_path['phpbb_urlR'];
		if ($this->filter_url($this->seo_stop_vars)) {
			$this->url = $this->seo_static['arcade'] . $this->seo_ext['arcade'];
			return;
		}
		$this->path = $this->seo_path['phpbb_url'];
		return;
