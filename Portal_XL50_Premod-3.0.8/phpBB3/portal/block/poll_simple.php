...
* @version $Id: poll_simple.php,v 1.3 2010/10/31 damysterious Exp $
*
...
if (!empty($topic_data['poll_start']))
{
	...
	$phpbb_seo->set_url($topic_data['forum_name'], $topic_data['forum_id'], $phpbb_seo->seo_static['forum']);
	$phpbb_seo->prepare_iurl($topic_data, 'topic', $topic_data['topic_type'] == POST_GLOBAL ? $phpbb_seo->seo_static['global_announce'] : $phpbb_seo->seo_url['forum'][$topic_data['forum_id']]);
	$phpbb_seo->set_user_url( $topic_data['username'], $topic_data['user_id'] );
