...
* @version $Id: leaders.php,v 1.3 2009/11/12 damysterious Exp $
*
...
$sql = $db->sql_build_query('SELECT', array(
	'SELECT'	=> 'u.user_id, u.group_id as default_group, u.username, u.user_colour, u.user_country_flag, u.user_website, u.user_allow_pm, g.group_id, g.group_name, g.group_colour, g.group_type, ug.user_id as ug_user_id',
