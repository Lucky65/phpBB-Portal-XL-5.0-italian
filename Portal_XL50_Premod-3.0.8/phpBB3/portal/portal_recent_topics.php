...
for( $i = 0; $i < count($line); $i++ )
{
	...
	$phpbb_seo->set_url($line[$i]['forum_name'], $line[$i]['forum_id'], $phpbb_seo->seo_static['forum']);
	$phpbb_seo->prepare_iurl($line[$i], 'topic', $line[$i]['topic_type'] == POST_GLOBAL ? $phpbb_seo->seo_static['global_announce'] : $phpbb_seo->seo_url['forum'][$line[$i]['forum_id']]);
