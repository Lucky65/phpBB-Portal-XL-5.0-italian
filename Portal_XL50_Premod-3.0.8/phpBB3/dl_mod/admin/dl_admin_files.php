...
* @file				dl_admin_files.php 25 2011/02/12 OXPUS
...
else if($action == 'save')
{
	...
	else
	{
		...
		if (!$file_extern)
		{
			...
			if (!$file_size)
			{
				trigger_error(sprintf($user->lang['DL_FILE_NOT_FOUND'], $new_real_file, $phpbb_root_path . $config['dl_download_dir'] . $file_path) . '1', E_USER_WARNING);
			}
		}
		else
		{
