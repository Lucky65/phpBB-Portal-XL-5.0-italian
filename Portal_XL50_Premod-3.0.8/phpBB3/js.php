...
* @version $Id: js.php,v 1.1.1.1 2009/05/15 05:12:37 damysterious Exp $
			...
			try
			{
				...
				if (hnr.readyState == 4)
				{
					...
					if (xml.getElementsByTagName('error') && xml.getElementsByTagName('error').length != 0)
					{
						...
						timer_in = setTimeout('reload_post();',500);
					}
					else
					{
