...
<br>'
	...
	array(
		...
		1 => '<p>&nbsp;</p>
<p><b>Portal XL Italia</b><strong> </strong>non è responsabile per 
...
particolare username assunto su Portal XL Italia e di cui 
l’utente, pertanto, se ne assume la piena responsabilità.</p>
<p></p>
<p align="justify">
</p><p align="justify"><strong>Portal XL Italia</strong> non si assume alcuna
...
appaiono in Portal XL Italia. <strong>Portal XL Italia</strong> non si assume 
...
<p align="justify">
</p><p align="justify"><strong>Portal XL Italia</strong> contiene links 
...
& servizi inclusi in Portal XL Italia vengono offerti <em>così
 come sono</em>, <strong>senza alcuna garanzia</strong> di nessun 
genere. <strong>Portal XL Italia</strong> dichiara espressamente di non 
...
dalla legge. <strong>Portal XL Italia</strong> non fornisce alcuna garanzia 
...
attraverso pubblicità su Portal XL Italia.</p>
<p align="justify">
...
codice HTML ed il Database di <b>q</b><strong><b>uesto sito</b> </strong>sono <strong>Copyright
 2009</strong> - <b>2011</b> di Portal XL Italia</p>
<p align="justify">
...
usate e processate su Portal XL Italia. Abbiamo la massima 
...
<strong>Portal XL Italia</strong> è l’esclusivo detentore delle informazioni 
...
l’identificazione., Portal XL Italia usa i cookies 
...
<strong>Portal XL Italia</strong> tiene un registro di files per analizzare i
...
I Links agli altri siti esterni a Portal XL Italia 
...
sono collegati/linkati su <strong>Portal XL Italia</strong>. Per cortesia 
...
esclusivamente a Portal XL Italia.</p>
<p align="justify">
...
Ogni volta che usi od accedi a Portal XL Italia, tu accetti le limitazioni 
...
servizio su o per mezzo di Portal XL Italia, sarai soggetto al rispetto di 
...
così come sono. Tu accetti che i proprietari di Portal XL Italia si 
riservano il diritto esclusivo e possono, in qualsiasi momento e senza 
alcuna responsabilità verso di te, modificare o sospendere Portal XL Italia 
...
Per l’utilizzo dei contenuti di Portal XL Italia, è d’obbligo la 
...
offensivo. Noi non potremo essere considerati responsabili in alcun modo
 per tali Contenuti che appaiono su Portal XL Italia o per qualsiasi errore 
od omissione.</p>
<p align="justify">
</p><p align="justify">Convieni ed accetti espressamente, con l’utilzzo 
di Portal XL Italia ed i servizi offerti, che non puoi e non devi:</p>
<p align="justify">
...
utenti;<br>
<strong>(d)</strong> Offrire od usare Portal XL Italia ed ogni suo 
...
<p align="justify">
</p><p align="justify"><strong>7. Invio di Contenuti su Portal XL Italia </strong><br>
...
e/o resi disponibili attravero Portal XL Italia. Le rappresentazioni fatte 
...
tua condotta, comportamento o relazione con Portal XL Italia e/o servizio, od
...
Convieni ed Accetti che l’utilizzo di ogni servizio di Portal XL Italia, di 
...
Portal XL Italia sia sicuro. Dichiari di aver compreso e di accettare che 
...
ogni altra questione insorta a seguito del tuo utilizzo di Portal XL Italia 
web o dei nostri servizi verrà regolata e definita in base alla legge 
vigente nel luogo ove è domiciliato il proprietario di Portal XL Italia, 
...
quella dove ha sede il proprietario di Portal XL Italia ovvero in Italia.</p>
<p align="justify">
...
reclamo o causa derivata da Portal XL Italia o dall’utilizzo dei suoi 
...
<strong>1.</strong> Devi attribuire la paternità del materiale a Portal XL Italia<br>
...
citata la fonte con un collegamento ipertestuale a Portal XL Italia.</strong></p><div
 style="overflow: hidden; color: rgb(0, 0, 0); background-color: 
transparent; text-align: left; text-decoration: none; border: medium 
none;" id="TixyyLink"> </div>'
	...
	array(
		...
		1 => '<p>
    &nbsp;
<p align="justify">Il download di stili speciali o mods su  Portal XL Italia e l’accesso al forum di Supporto riservato ai Donatori Vip è disponibile in cambio di una donazione!</p>
<p align="justify">Il progetto di Portal XL Italia è gratuito, ma anche una piccola <a href="./donate.php" title="Donazione" target="_blank">donazione</a> motiverà maggiormente il progetto a beneficio della comunità e ci consentirà il mantenimento del server e di Portal XL Italia on-line. 
Per le donazioni inferiori a € 10.00 non sarà garantito l’accesso  alla nostra sezione downloads <b>Donatori Vip</b>, ma sosterrà i nostri costi di server servizi e aggiornamenti futuri!</p>
<p align="justify">Se non desideri sostenere il progetto Portal XL Italia ma desideri ricevere un certo numero di stili, con una donazione di € 5.00 ti sarà garantito uno stile a scelta che ti sarà inviato per messaggio privato o E-Mail.</p>
<p align="justify">Il sito Portal XL Italia offre tre  livelli di donatori:
          </p>
<ul type="disc">   
<ol type="1">
        <div align="justify">
            <li>Primo, <b>&quot;Donatore&quot;</b>* donando un importo minimo di € 10.00 si otterrà pieno accesso per un’anno nel nostro forum  Portal XL Italia riservato ai Donatori Vip, e due download a scelta inviato via email o messaggio privato. 
            <br />
             </li>
            <li>Secondo, <b>&quot;Donatore Vip&quot;</b>* donando un importo minimo di € 30.00 in cambio offriamo 1 anno sola area forum riservata ai donatori vip + 1 piano hosting annuale Medium, tutte le info <a tip="" href="http://www.portalxl.eu/hosting.php" class="INTERNAL_LINK_CLASS">qui</a> + uno&nbsp;<a tip="Stile per eseguire lo script, generalmente è il tema usato in phpBB" class="INTERNAL_LINK_CLASS">stile</a> a scelta su <a tip="" href="http://www.portalxl.nl/forum/" target="_blank" class="EXTERNAL_LINK_CLASS" rel="nofollow" onclick="this.target=\'_blank\';">DaMysterious</a> da inviare via messaggio privato o email;</li>
            <li>Terzo, &quot;<b>Donatore Premium</b>&quot;* otterrà pieno accesso annuale area downloads e forum vip + 1 piano 
hosting Large o Extra Large. Se effettua una donazione di €. 55,00 sarà 
attivato il piano Large, se effettua una donazione di €. 75,00 sarà 
attivato il piano Extra Large, tutte le info <a tip="" href="http://www.portalxl.eu/hosting.php" class="INTERNAL_LINK_CLASS">qui</a>. 
            &nbsp;</li>
        </div>
          </ol>      
    </ul>
<p align="justify">&nbsp;
<p align="justify">Se in futuro un\'utente che ha già aderito al gruppo Donatori, vuole 
aderire al gruppo Donatori Vip o Premium dovrà solo inviare la differenza con una
 nuova donazione  in questo modo sarà riequilibrato il suo account, 
in tutti i casi è sepre possibile integrare la differenza al fine di 
riequilibrare l\'account.</p>
<p align="justify">Sollecitiamo tutti gli utenti affinchè siano più generosi possibile, affinchè questo progetto di Portal XL Italia vada avanti.</p>
<p align="justify">Accettiamo solo transazioni PayPal.</p>
<p align="justify">* Nota: Ogni account VIP su Portal XL Italia è strettamente privato e legata alla user-id e all’indirizzo ip. Condividere il tuo account VIP con altri utenti è severamente proibito! Tutte le azioni contro questa regola comporta a perdere la tua iscrizione VIP su Portal XL Italia immediatamente. Ricorda che, anche se si limita la visibilità di un collegamento tutte le azioni su Portal XL Italia sono &nbsp;registrate per rintracciare gli abusi.</p>
    &nbsp;'
	),
);
